...
code.withIcon = `<Input type="text" placeholder="请输入内容..." icon="ios-person" @iconClick="iconClick"></Input>
...
code.size = `<Input type="text" placeholder="请输入内容..."></Input>
<Input type="text" mini placeholder="请输入内容..."></Input>`
