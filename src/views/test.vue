<template>
  <div style="max-width: 600px">
    <Button type="primary" @click="console.log('ww')" :loading="true">Submit</Button>
    <Form
      name="rules"
      :rules="rules"
      :model="form"
    ...
    >
      ...
      <FormItem label="Country">
        <FormItem prop="country">
          <Select clearable style="width: 100%">
            <Option value="0" label="China" /> <Option value="1" label="Russia" />
          </Select>
        </FormItem>
        <FormItem prop="city">
          <Select clearable style="width: 100%">
            <Option value="0" label="Shanghai" /> <Option value="1" label="Wuhan" />
      ...
      <FormItem label="Hobby" prop="hobbies">
        <CheckboxGroup>
          <Checkbox value="0" label="Football" /> <Checkbox value="1" label="Music" />
          <Checkbox value="2" label="Photograph" /> <Checkbox value="3" label="Tennis" />
        </CheckboxGroup>
      </FormItem>
