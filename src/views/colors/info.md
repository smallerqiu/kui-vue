...
| 展示 (Table, Descriptions, Timeline)           | 表头背景用 --kui-color-bg-component，分割线用 --kui-color-border-split |
| 浮层 (Tooltip, Poptip, Dropdown)               | 背景建议用 --kui-color-bg-elevated，并配合 --kui-color-shadow          |
| 骨架屏 (Skeleton)                              | 背景用 --kui-color-bg-component，动画色块用 --kui-color-fill-active    |
