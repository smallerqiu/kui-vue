...
@main: #3a95ff //主体颜色
  ...
  @warning #00bb5d //警告颜色
  @danger #00bb5d //危险颜色
  @font-color: rgba(0, 0, 0, 0.75); //字体颜色
@title-color: rgba(0, 0, 0, 0.85); //标题凸显颜色
@sub-title-color: rgba(0, 0, 0, 0.85); //副标题凸显颜色
@back-color: #fff; //组件背景
@mask-color: rgba(0, 0, 0, 0.6); //蒙层背景
@icon-color: rgba(0, 0, 0, 0.4); //图标颜色
...
@disable-color: rgba(0, 0, 0, 0.3); //禁用文字颜色
```
