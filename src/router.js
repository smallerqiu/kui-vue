...
let children = [
  ...
  { path: "/data/avatar", component: () => import( "../components/avatar/demo") },
  { path: "/data/card", component: () => import( "../components/card/demo") },
  { path: "/data/carousel", component: () => import( "../components/carousel/demo") },
  { path: "/data/collapse", component: () => import( "../components/collapse/demo") },
  ...
  { path: "/data/descriptions", component: () => import( "../components/descriptions/demo") },
  ...
  { path: '/data/timeline', component: () => import('../components/timeline/demo'), },
