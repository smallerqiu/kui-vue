...
var it = (h, c) => () => (c || h((c = { exports: {} }).exports, c), c.exports);
var st = (h, c, g, _) => {
  if ((c && typeof c == "object") || typeof c == "function")
    for (let M of et(c))
      !rt.call(h, M) &&
        M !== g &&
        E(h, M, { get: () => c[M], enumerable: !(_ = tt(c, M)) || _.enumerable });
  return h;
};
var ut = (h, c, g) => (
  (g = h != null ? X(nt(h)) : {}),
  st(c || !h || !h.__esModule ? E(g, "default", { value: h, enumerable: !0 }) : g, h)
);
var P = it((F, J) => {
  (function (h, c) {
    ...
    var h = 1e3,
      ...
      R = {
        ...
        p: function (i) {
          return (
            { M: v, y: p, w: W, d: D, D: Y, h: T, m: k, s: M, ms: _, Q: z }[i] ||
            String(i || "")
              .toLowerCase()
              .replace(/s$/, "")
          );
        ...
        return (
            ...
            var e = this,
              ...
              f = function (b, m) {
                return a.w(
                  e
                    .toDate()
                    [b].apply(e.toDate("s"), (s ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(m)),
                  e
                );
              },
              $ = this.$W,
          ...
          (n.add = function (t, r) {
            ...
            var u = a.p(r),
              o = function (l) {
                var y = d(s);
                return a.w(y.date(y.date() + Math.round(l * t)), s);
              };
            if (u === v) return this.set(v, this.$M + t);
            if (u === p) return this.set(p, this.$y + t);
            if (u === D) return o(1);
            if (u === W) return o(7);
            var f = ((e = {}), (e[k] = c), (e[T] = g), (e[M] = h), e)[u] || 1,
              $ = this.$d.getTime() + t * f;
            return a.w($, this);
          }),
          ...
          (n.format = function (t) {
            ...
            var s = t || "YYYY-MM-DDTHH:mm:ssZ",
              ...
              H = e.meridiem,
              O = function (m, S, L, I) {
                return (m && (m[S] || m(r, s))) || L[S].slice(0, I);
              },
              x = function (m) {
