...
var Affix = /* @__PURE__ */ defineComponent({
    ...
    setup(props, { slots, emit }) {
      ...
      const updatePosition = () => {
        ...
        if (props.offsetBottom !== void 0)
          if (targetRect.bottom - rect.bottom - props.offsetBottom <= 0) {
            isFixed = true;
            styles.value = {
              position: "fixed",
  ...
  _l = [
    {
      d: "M432 112V96a48 48 0 0 0 -48 -48H64A48 48 0 0 0 16 96V352a48 48 0 0 0 48 48H80M142 128H450A46 46 0 0 1 496 174V418A46 46 0 0 1 450 464H142A46 46 0 0 1 96 418V174A46 46 0 0 1 142 128z",
      s: "fill:none;stroke:currentcolor;stroke-linejoin:round;stroke-width:32px",
    },
    {
      d: "M342 372L255 286a31 31 0 0 0 -42 -1L96 387.5M265 464L384 346.5a31 31 0 0 1 41.5 -2L496 403",
      s: "fill:none;stroke:currentcolor;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px",
    },
    {
      d: "M342 219.5A31 30.5 0 1 0 403.5 219.5A31 30.5 0 1 0 342 219.5z",
      s: "fill:none;stroke:currentcolor;stroke-miterlimit:10;stroke-width:32px",
    },
  ],
  lo = [
  ...
  setup(props, { emit, slots }) {
    ...
    return () => {
      ...
      const descriptionNode = props.description
        ? createVNode("div", { class: "k-alert-description" }, [props.description])
        : null;
      const msgNode = createVNode("div", { class: "k-alert-message" }, [
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    return () => {
      return createVNode(
        ...
        [
          createVNode("div", { class: "k-anchor" }, [
            createVNode(
              "span",
              {
    ...
    return () => {
      return createVNode(
        "div",
        {
          class: [
            "k-anchor-link",
            { "k-anchor-link-active": anchorContext?.activeLink.value === props.href },
          ],
        },
        [
          createVNode(
...
var Avatar = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const updateSize = () => {
      if (innerRef.value && rootRef.value) {
        ...
        if (innerWidth > 0 && innerWidth > max)
          textStyles.value = {
            transform: `scale(${Math.min(max / innerWidth, 1)}) translateX(-50%)`,
          };
    ...
    return () => {
      ...
      return createVNode("div", rootProps, [
        icon
          ? createVNode(Icon, { type: icon }, null)
          : src
            ? createVNode(
                "img",
                {
            ...
            : isText
              ? createVNode("span", textProps, [children])
              : children,
      ]);
    };
  },
...
function cloneNodes(vnode, props, merge = false, cloneTransition) {
  return vnode.length == 1
    ...
    : cloneVNode(createVNode("span", null, [vnode]), props, merge, cloneTransition);
}
...
var Breadcrumb = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      return createVNode("nav", { class: "k-breadcrumb" }, [
        createVNode("ol", null, [slots.default?.()]),
      ]);
    };
  },
});
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      const iconNode = slots.icon
        ? slots.icon()
        : props.icon
          ? createVNode(Icon, { type: props.icon }, null)
          : null;
      const itemProps = {
      ...
      return createVNode("li", itemProps, [
        props.href
          ? createVNode("a", linkProps, [content])
          : createVNode("span", { class: "k-breadcrumb-link" }, [content]),
        createVNode("span", { class: "k-breadcrumb-separator" }, [separator]),
      ]);
    };
  },
});
  ...
  setup(props, { emit, slots }) {
    ...
    return () => {
      ...
      if (!children || children.length === 0)
        children = [
          createVNode("div", { class: "k-back-top-content" }, [
            createVNode(Icon, { type: h$1 }, null),
          ]),
        ];
      const rootProps = {
        class: "k-back-top",
      ...
      return createVNode(
        Transition,
        { name: "k-back-top-fade" },
        {
          default: () => [
            withDirectives(createVNode("div", rootProps, [children]), [
              [vShow, visible.value],
              [resolveDirective("scroll"), onScroll],
            ]),
          ],
        }
      );
...
var Badge = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    return () => {
      ...
      return createVNode("div", { class: "k-badge" }, [children, supNode, statusNodes]);
    };
  },
});
//#endregion
...
var Button = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit, slots, attrs }) {
    ...
    return () => {
      ...
      let childNodes = [];
      const iconType = props.loading ? Ao : props.icon;
      if (iconType)
        childNodes.push(
          createVNode(
            Icon,
      ...
      return props.type === "link" && props.href && !props.disabled
        ? createVNode("a", commonProps, [childNodes])
        : createVNode("button", commonProps, [childNodes]);
    };
  },
});
//#endregion
  ...
  setup(props, { slots, attrs }) {
    return () => {
      ...
      const extraNode = extraSlot
        ? createVNode("div", { class: "k-card-extra" }, [extraSlot])
        : null;
      const iconNode = icon
        ? createVNode(
            Icon,
      ...
      const titleNode = title
        ? createVNode("span", { class: "k-card-title" }, [title])
        : titleSlot || null;
      return createVNode(
        "div",
        {
        ...
        [
          titleNode &&
            createVNode("div", { class: "k-card-head" }, [iconNode, titleNode, extraNode]),
            ...
            !vertical &&
              createVNode(Fragment, null, [
                ...
                createVNode(
                  ...
                  [createVNode(Icon, { type: z }, null)]
                ),
              ]),
            dots &&
              createVNode("ul", { class: "k-carousel-dots" }, [
                items.map((_, i) =>
                  createVNode(
                    "li",
                    {
...
var Checkbox = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      ...
      const innerNode = isChecked.value
        ? createVNode(
            Icon,
            {
              type: Bc,
      ...
      return createVNode("label", rootProps, [
        createVNode("span", { class: "k-checkbox-symbol" }, [
          createVNode("input", inputProps, null),
          innerNode,
        ]),
        labelNode ? createVNode("span", { class: "k-checkbox-label" }, [labelNode]) : null,
      ]);
    };
  },
});
...
var Collapse = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      return createVNode("div", { class: ["k-collapse", { "k-collapse-sample": props.sample }] }, [
...
var CollapsePanel = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      const rootProps = {
        class: ["k-collapse-item", { "k-collapse-item-active": expanded.value }],
      };
      const extraNode = slots.extra?.();
      const transitionProps = getTransitionProp("k-collapse-slide");
      const panelNode = rendered.value
        ? createVNode(Transition, mergeProps(transitionProps, { duration: 350 }), {
            default: () => [
              withDirectives(
                createVNode("div", { class: "k-collapse-content" }, [
                  createVNode("div", { class: "k-collapse-content-box" }, [slots.default?.()]),
                ]),
...
var alpha_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () =>
      createVNode("div", { class: "k-color-picker-alpha-box" }, [
        createVNode(
          "canvas",
          {
...
var hue_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    ...
    onBeforeUnmount(onMouseUp);
    return () =>
      createVNode("div", { class: "k-color-picker-hue-box" }, [
        createVNode(
          "canvas",
          {
  ...
  setup(props, { slots, emit, attrs, expose }) {
    ...
    const getSuffix = (slotSuffix) => {
      ...
      return slotSuffix.length > 0
        ? slotSuffix
        : suffix
          ? createVNode("div", { class: "k-input-suffix" }, [suffix])
          : null;
    };
    return () => {
      const {
        icon,
        size = parentSize || void 0,
        disabled,
        type,
        clearable,
        suffix,
      ...
      if (slotPrefix.length > 0 || slotSuffix.length > 0) {
        const preChildren = slotPrefix.length
          ? createVNode("div", { class: "k-input-group-prefix" }, [slotPrefix])
          : null;
        const innerChildren = [];
        if (icon)
          innerChildren.push(
        ...
        if (prefix)
          innerChildren.push(createVNode("div", { class: `k-${inputType}-prefix` }, [prefix]));
        ...
        const sufChildren =
          slotSuffix.length > 0
            ? createVNode("div", { class: "k-input-group-suffix" }, [slotSuffix])
            : null;
        return createVNode(
          InputGroup,
          {
    ...
    return () => {
      ...
      const controls =
        props.controls && !props.readonly && !props.disabled
          ? createVNode("div", { class: "k-input-number-controls" }, [
              createVNode(
                "span",
                {
      ...
      return createVNode(
        ...
        [
          createVNode("span", null, [
            labelText.value,
            multiple ? createVNode(Icon, { type: Bc }, null) : null,
          ]),
        ]
      );
    };
...
var Empty = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      return createVNode("div", { class: "k-empty" }, [
        createVNode("div", { class: "k-empty-content" }, [
          ...
          description !== null
            ? createVNode("p", { class: "k-empty-description" }, [
...
var Select = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const filterOptions = () => {
      ...
      return props.filterable && key.trim() !== ""
    ...
    const renderOverlay = () => {
      ...
      const loadingNode = createVNode("div", { class: "k-select-loading" }, [
        createVNode(
          Icon,
          {
            type: Ao,
        ...
        createVNode("span", null, [locale.value?.k.select.loading]),
      ]);
      return createVNode(
        Transition,
        { name: `${preCls}` },
        {
          default: () => [
            withDirectives(
              createVNode("div", popperProps, [
                props.loading
                  ? loadingNode
                  : optionNodes.length
                    ? createVNode("ul", null, [optionNodes])
                    : createVNode(
                        Empty,
                        {
                          onClick: emptyClick,
    ...
    return () => {
      ...
      let childNode = [];
      const finalArrowIcon = arrowIcon || Nc;
      const queryNode = withDirectives(
        createVNode(
          "div",
          {
            key: "search",
      ...
      const placeNode =
        placeholderText && isEmpty(labelText.value) && !queryKey.value
          ? createVNode("div", { class: "k-select-placeholder" }, [placeholderText])
          : null;
      const renderTags = () => {
        ...
        if (props.maxTagCount && props.maxTagCount > 0 && tags.length > props.maxTagCount) {
          ...
          tags.push(
            createVNode("span", { class: "k-select-tag" }, [
              createTextVNode("+"),
      ...
      const labelsNode = multiple
        ? createVNode("div", { class: "k-select-labels" }, [renderTags(), queryNode])
        : !isEmpty(labelText.value)
          ? withDirectives(createVNode("div", { class: "k-select-label" }, [labelText.value[0]]), [
              [vShow, !queryKey.value.length],
            ])
          : null;
...
var mode_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => {
      ...
      return createVNode(
        "div",
        { class: `k-color-picker-mode k-color-picker-${currentMode.value}` },
        [
          createVNode(
            Select,
            {
          ...
          createVNode("div", { class: "k-color-picker-val" }, [[...nodes]]),
        ]
      );
    };
  },
...
var paint_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () =>
      createVNode("div", { class: "k-color-picker-paint-container" }, [
        createVNode(
          "canvas",
          {
...
var presets_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    return () => {
      ...
      return createVNode("div", { class: "k-color-picker-presets" }, [
        props.modelValue.map((hex) =>
          createVNode(
            "span",
            {
            ...
            [Color(props.color) == Color(hex) ? createVNode(Icon, { type: Bc }, null) : null]
          )
        ),
      ]);
    };
  ...
  setup(props, { emit, slots }) {
    ...
    const renderTriggerText = () => {
      ...
      return props.showText
        ? createVNode("div", { class: "k-color-picker-trigger-text" }, [text])
        : null;
    };
    ...
    const renderDrop = () => {
      ...
      return createVNode(
        ...
        { name: "k-color-picker" },
        {
          default: () => [
            withDirectives(
              createVNode("div", _props, [
                createVNode("div", { class: "k-color-picker-body" }, [
                  createVNode(
                    paint_default,
                    {
                  ...
                  createVNode("div", { class: "k-color-picker-bar" }, [
                    createVNode("div", { class: "k-color-picker-avatar" }, [
                      createVNode(
                        "div",
                        {
                    ...
                    createVNode("div", { class: "k-color-picker-bar-box" }, [
                      createVNode(
                        hue_default,
                        {
                          hue: currentHue.value,
                ...
                createVNode("div", { class: `k-color-picker-arrow` }, [
                  createVNode(
                    "svg",
                    {
    ...
    return () => {
      ...
      return slots.default
        ...
        : withDirectives(
            createVNode(
              ...
              [
                createVNode(
                  ...
                  [
                    createVNode("div", { class: "k-color-picker-color" }, [
                      createVNode(
                        "div",
                        {
            ...
            [[resolveDirective("resize"), updatePopPosition]]
          );
    };
  },
});
        ...
        if ("string" == typeof a) {
          ...
          (h && (d = o[2]),
            ...
            (this.$d = (function (e, t, n, r) {
              try {
                if (["x", "X"].indexOf(t) > -1)
                  return /* @__PURE__ */ new Date(("X" === t ? 1e3 : 1) * e);
                var i = l(t)(e),
                  o = i.year,
                  s = i.month,
                  a = i.day,
            ...
            u && t != this.format(a) && (this.$d = /* @__PURE__ */ new Date("")),
            (s = {}));
...
var require_isBetween = /* @__PURE__ */ __commonJSMin((exports, module) => {
  (function (e, i) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ? define(i)
        : ((e = "undefined" != typeof globalThis ? globalThis : e || self).dayjs_plugin_isBetween =
            i());
  })(exports, function () {
    "use strict";
...
var require_localeData = /* @__PURE__ */ __commonJSMin((exports, module) => {
  (function (n, e) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ? define(e)
        : ((n = "undefined" != typeof globalThis ? globalThis : n || self).dayjs_plugin_localeData =
            e());
  })(exports, function () {
    "use strict";
...
//#endregion
//#region components/date-picker/dayjs.zh_CN.ts
...
var DatePicker = /* @__PURE__ */ defineComponent({
  ...
  props: {
    modelValue: {
      type: [Date, Object, Array, String, Number],
      default: null,
    },
    startDate: {
  ...
  setup(props, { emit, slots }) {
    ...
    const renderHeader = () => {
      ...
      const yearNode = createVNode("span", { onClick: () => (currentView.value = "year") }, [
        `${year}${locale.value.k.datePicker.year || ""}`,
      ]);
      const monthNode =
        props.mode !== "year"
          ? createVNode(
      ...
      return createVNode("div", { class: "k-picker-header" }, [
        ...
        props.mode !== "year"
          ...
          : null,
        createVNode("span", { class: "k-picker-header-label" }, [
    ...
    const renderYearTable = () => {
      ...
      return createVNode("div", { class: "k-picker-body" }, [
        createVNode("div", { class: "k-picker-year-body" }, [
          Array.from({ length: 12 }, (_, i) => startY - 1 + i).map((y) =>
            createVNode(
              "div",
              {
                key: y,
    ...
    const renderMonthTable = () => {
      return createVNode("div", { class: "k-picker-body" }, [
        createVNode("div", { class: "k-picker-month-body" }, [
          local()
            .monthsShort()
            .map((m, i) =>
              createVNode(
    ...
    const renderDateTable = () => {
      ...
      return createVNode("div", { class: "k-picker-body" }, [
        createVNode("div", { class: "k-picker-weekdays" }, [
          [...weekDaysRaw.slice(firstDayOfWeek), ...weekDaysRaw.slice(0, firstDayOfWeek)].map((w) =>
            createVNode(
              "span",
              {
    ...
    const renderFooter = () => {
      ...
      if (props.mode === "dateTimeRange") {
        const [s, e] = (innerValue.value || [null, null]).map((d) =>
          d ? d.format("HH:mm:ss") : "--:--:--"
        );
        return createVNode("div", { class: "k-picker-footer" }, [
          ...
          createVNode("span", { class: "k-picker-footer-time-split" }, [
            createVNode(Icon, { type: z }, null),
          ]),
          createVNode(
            "div",
    ...
    return () => {
      ...
      const dateIcon = props.mode == "time" ? kn : props.dateIcon || lc;
      const overlayProps = {
      ...
      const renderInput = () => {
        ...
        if (isRange.value) {
          ...
          return [
            ...
            createVNode("span", { class: "k-datepicker-separator" }, [
              createVNode(Icon, { type: z }, null),
            ]),
            createVNode(
              "input",
      ...
      const renderPresets = () => {
        if (props.presets && props.presets.length > 0)
          return createVNode("div", { class: "k-picker-presets" }, [
            props.presets.map((x) => {
              return createVNode(
                Button,
                {
      ...
      const renderExtraHeader = () => {
        return slots.header
          ? createVNode("div", { class: "k-picker-extra-header" }, [
      ...
      const renderExtraFooter = () => {
        return slots.footer
          ? createVNode("div", { class: "k-picker-extra-footer" }, [
      ...
      const overlay = rendered.value
        ? createVNode(
            ...
            { name: "k-date-picker" },
            {
              default: () => [
                withDirectives(
                  createVNode("div", overlayProps, [
                    renderPresets(),
                    createVNode("div", { class: "k-picker-container" }, [
                      renderExtraHeader(),
                      renderHeader(),
  ...
  setup(props, { slots }) {
    return () => {
      ...
      if (layout === "vertical") {
        ...
        if (type === "label")
          return createVNode(
            ...
            [
              createVNode("div", { class: "k-descriptions-item-inner" }, [
                createVNode("div", { class: "k-descriptions-item-label" }, [label]),
              ]),
            ]
          );
        return createVNode(
          ...
          [
            createVNode("div", { class: "k-descriptions-item-inner" }, [
              createVNode("div", { class: "k-descriptions-item-content" }, [children]),
            ]),
          ]
        );
      }
      return createVNode(
        ...
        [
          createVNode("div", { class: "k-descriptions-item-inner" }, [
            label && createVNode("div", { class: "k-descriptions-item-label" }, [label]),
            createVNode("div", { class: "k-descriptions-item-content" }, [children]),
          ]),
        ]
      );
...
var Descriptions = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    return () => {
      ...
      return createVNode("div", wrapperProps, [
        createVNode("div", { class: "k-descriptions-header" }, [
          createVNode("div", { class: "k-descriptions-title" }, [title || slots.title?.()]),
          extraNode && createVNode("div", { class: "k-descriptions-extra" }, [extraNode]),
        ]),
        createVNode("div", { class: "k-descriptions-view" }, [
          createVNode("table", null, [createVNode("tbody", null, [trs])]),
        ]),
      ]);
    };
  },
...
var Drawer = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      ...
      const cancelBtn = createVNode(
        Button,
        { onClick: cancel },
        { default: () => [cancelText || locale.value?.k?.common?.cancel] }
      );
      const okBtn = createVNode(
        Button,
        {
          type: "primary",
          onClick: ok,
      ...
      const footNode = hasFooter
        ? createVNode("div", { class: "k-drawer-footer" }, [
      ...
      return rendered.value
        ? withDirectives(
                  ...
                  [
                    createVNode(
                      ...
                      { name: transitionName },
                      {
                        default: () => [
                          withDirectives(
                            createVNode("div", drawerProps, [
                              createVNode("div", { class: "k-drawer-content" }, [
                                createVNode("div", { class: "k-drawer-header" }, [
                                  closeNode,
                                  createVNode("div", { class: "k-drawer-header-inner" }, [title]),
                                ]),
            ...
            [[resolveDirective("transfer"), target]]
          )
        : null;
    };
  },
...
var Dropdown = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    return () => {
          ...
          ? createVNode(
              ...
              { name: "k-dropdown" },
              {
                default: () => [
                  withDirectives(
                    createVNode("div", _props, [
                      createVNode("div", { class: `k-dropdown-content` }, [
                        createVNode("div", { class: `k-dropdown-body` }, [slots.overlay?.()]),
                        props.arrow
                          ? createVNode("div", { class: `k-dropdown-arrow` }, [
                              createVNode(
                                "svg",
                                {
                                  style: { fill: "currentcolor" },
      ...
      return [
        cloneVNode(
          nodes.length == 1 ? nodes[0] : createVNode("span", null, [nodes]),
          {
            ref: refSelection,
            ...pp,
            ...attrs,
      ...
      return createVNode(
        ...
        [
          props.type === "horizontal" && hasText
            ? createVNode("span", { class: "k-divider-inner-text" }, [textNode])
            : null,
        ]
      );
    };
    ...
    const test = (rule) => {
      ...
      if (rule.required) {
        isValid = Array.isArray(itemValue)
          ? itemValue.length > 0
          : itemValue !== null && itemValue !== void 0 && itemValue !== "" && itemValue !== false;
    ...
    return () => {
      ...
      return createVNode(
        ...
        },
        {
          default: () => [
            label
              ? createVNode(Col, mergeProps({ class: "k-form-item-label" }, labelProp), {
                  default: () => [createVNode("label", { for: id }, [label])],
                })
              : null,
            createVNode(Col, wrapperProp, {
              default: () => [
                createVNode("div", { class: "k-form-item-content" }, [
                  children.map((child) => {
                    if (isVNode(child)) {
                  ...
                  prop
                    ? createVNode(
                        ...
                        { name: "k-form-item-fade" },
                        {
                          default: () => [
                            !valid.value
                              ? createVNode("div", { class: "k-form-item-error-tip" }, [
                                  message.value,
                                ])
                              : null,
                          ],
          ...
          ? createVNode(
              ...
              { name: `k-${preCls}` },
              {
                default: () => [
                  withDirectives(
                    createVNode("div", overlayProps, [
                      createVNode("div", contentProps, [
                        createVNode("div", { class: `k-${preCls}-title` }, [title]),
                        createVNode("div", { class: `k-${preCls}-arrow` }, [
                          createVNode("svg", mergeProps(arrowProps, { viewBox: "0 0 24 7" }), [
                            createVNode(
                              "path",
                              {
...
var Slider = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const formatValue = (val) => {
      if (props.range)
        return sortValue(
          (Array.isArray(val) ? [...val] : [props.min, props.min]).map((v) =>
            getClosestStep(v, props)
          )
        );
    ...
    return () => {
      ...
      const renderMarks = () => {
        ...
        return createVNode("div", { class: "k-slider-marks" }, [
          Object.keys(marks)
            .map(Number)
            .map((val) => {
              ...
              return createVNode(
                ...
                [
                  ...
                  createVNode("div", { class: ["k-slider-mark-text", { "is-active": isActive }] }, [
                    marks[val],
                  ]),
                ]
              );
...
var ImagePreview = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    onMounted(() => {
      if (typeof window !== "undefined") {
        const touch =
          "ontouchstart" in window || navigator.maxTouchPoints > 0 || window.TouchEvent !== void 0;
        state.touch = touch;
    ...
    return () => {
      ...
      return createVNode("div", { class: "k-image-preview-root" }, [
        withDirectives(
          createVNode("div", { class: "k-image-preview" }, [
            createVNode(
              Transition,
              { name: "k-image-fade" },
              {
              ...
              [
                createVNode(
                  ...
                  { name: "k-image-fade" },
                  {
                    default: () => [
                      withDirectives(
                        createVNode("ul", { class: "k-image-preview-control" }, [
                ...
                createVNode(
                  ...
                  [
                    type == "media"
                      ? withDirectives(
                          createVNode("video", mergeProps({ controls: true }, imgProps), null),
                          [[vShow, visible]]
                        )
                      : !state.error && !state.loading
                        ? withDirectives(createVNode("img", imgProps, null), [[vShow, visible]])
                        : !loading
                          ? createVNode("div", { class: "k-image-preview-img-error" }, [
                              createVNode(Icon, { type: Yl }, null),
                            ])
                          : null,
                  ]
                ),
                props.data.length > 1
                  ...
                  : null,
                loading
                  ? createVNode("div", { class: "k-image-preview-loading" }, [
                      createVNode(
                        Icon,
                        {
                          type: Ao,
...
var KImage = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    return () => {
      ...
      if (loading.value)
        nodes.push(
          createVNode("div", { class: "k-image-loading" }, [
            createVNode(
              Icon,
              {
                type: Ao,
        ...
        if (imageUrl.value) nodes.push(createVNode("img", imgProps, null));
        else
          nodes.push(
            createVNode(
              Icon,
    ...
    return () => {
      ...
      return createVNode(
        ...
        { name: "fade" },
        {
          default: () => [
            withDirectives(
              createVNode("div", { class: "k-loading-container" }, [
                createVNode("div", lineProps, null),
              ]),
              [[vShow, visible.value]]
            ),
          ],
...
var MenuItem = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      let titleNode = createVNode("span", { class: `k-${preCls}-title-content` }, [
        title || getChildren(slots.default?.()),
      ]);
      return createVNode("li", _props, [
        slots.icon
          ? createVNode("span", { class: `k-${preCls}-item-icon` }, [slots.icon()])
          : icon
            ? createVNode(
                Icon,
                {
  ...
  setup(props, { slots }) {
      ...
      return rendered.value
        ? createVNode(
            ...
            { name: `k-${preCls}-popup` },
            {
              default: () => [
                withDirectives(
                  createVNode("div", mergeProps({ class: `k-${preCls}-popup` }, popperPros), [
                    createVNode("div", { class: `k-${preCls}-sub` }, [
                      createVNode("ul", { class: `k-menu k-menu-vertical` }, [menuItems]),
                    ]),
                  ]),
                  [
                    [vShow, opened],
    ...
    const renderSubmenu = () => {
      ...
      if (menuMode.value != "horizontal") {
        const node = [
          createVNode(Transition, getTransitionProp("k-collapse-slide"), {
            default: () => [
              withDirectives(
                createVNode("div", { class: `k-${preCls}-sub` }, [
                  createVNode("ul", { class: `k-menu k-menu-${menuMode.value}` }, [
                    slots.default?.(),
                  ]),
                ]),
                [[vShow, opened && !inlineCollapsed.value && menuMode.value != "vertical"]]
              ),
            ],
          }),
        ];
    ...
    return () => {
      ...
      const titleNode = createVNode("div", titleProps, [
        ...
        menuMode.value == "horizontal" && !keyPah.length
          ? null
          : createVNode("i", { class: `k-${preCls}-arrow` }, null),
      ]);
      const classes = [
        `k-${preCls}`,
        {
...
var MenuDivider = /* @__PURE__ */ defineComponent({
  ...
  setup() {
    ...
    return () => {
      return createVNode(
        "li",
        { class: `k-${dropdown ? "dropdown-menu" : "menu"}-item-divider` },
        null
      );
    };
  },
...
var MenuGroup = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    return () => {
      return createVNode("li", { class: "k-menu-item-group" }, [
        createVNode("div", { class: "k-menu-item-group-title" }, [props.title || slots.title?.()]),
        createVNode("ul", { class: "k-menu-item-group-list" }, [slots.default?.()]),
      ]);
    };
  },
});
  ...
  setup(props, { emit }) {
    ...
    return () => {
      ...
      return createVNode("div", { class: classes }, [
        createVNode("div", { class: `k-${noticeType}-content` }, [...children]),
      ]);
    };
  },
});
...
var container_default = /* @__PURE__ */ defineComponent({
  ...
  setup(ps, { expose }) {
    ...
    return () => {
      ...
      return createVNode(TransitionGroup, mergeProps({ tag: "div" }, transitionProps), {
        default: () => [...children],
      });
    };
  },
...
var Modal = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      ...
      let maskNode = null;
      if (props.mask)
        maskNode = createVNode(
          Transition,
          { name: "k-modal-fade" },
          {
            default: () => [
              withDirectives(createVNode("div", { class: "k-modal-mask" }, null), [
                [vShow, visible.value],
              ]),
            ],
          }
      ...
      if (!contentNode) {
        ...
        if (props.footer) {
          ...
          if (!footer)
            footer = [
              createVNode(
                Button,
                { onClick: cancel },
                _isSlot$3(cancelText) ? cancelText : { default: () => [cancelText] }
              ),
              createVNode(
                Button,
                {
          ...
          const footerNode = footer
            ? createVNode("div", { class: "k-modal-footer" }, [footer])
            : null;
          contents.push(footerNode);
        }
        contentNode = createVNode(
          "div",
          {
        ...
        ? withDirectives(
            createVNode("div", { class: classes }, [
              ...
              withDirectives(
                        ...
                        default: () => [
                          withDirectives(
                            createVNode(
                              ...
                              [contentNode, createVNode("div", { tabindex: "0" }, null)]
                            ),
                            [[vShow, visible.value]]
                          ),
                        ],
                ...
                [[vShow, showInner.value]]
              ),
            ]),
            [[resolveDirective("transfer"), props.transfer]]
          )
        : null;
    };
  },
...
var toast_default = /* @__PURE__ */ defineComponent({
  ...
  setup(ps, { expose, emit }) {
    ...
    return () => {
      ...
      let header = createVNode("div", { class: "k-toast-header" }, [
        type || icon
          ? createVNode(
              Icon,
              {
          ...
          : null,
        createVNode("div", { class: "k-toast-title" }, [title]),
      ]);
      ...
      if (type == "confirm")
        footerNode.unshift(
          createVNode(
            Button,
            { onClick: cancel },
            { default: () => [createTextVNode(" "), cancelText || locale.value?.k.common.cancel] }
          )
        );
  ...
  setup(props, { emit }) {
        ...
        const moreNode = createVNode(
          ...
          [
            createVNode(
              ...
              {
                strokeWidth: 30,
                type: prevPageGroup.value ? Gc : Fr,
              },
              null
            ),
          ]
        ...
        const moreNode = createVNode(
          ...
          [
            createVNode(
              ...
              {
                strokeWidth: 30,
                type: nextPageGroup.value ? Ic : Fr,
              },
              null
            ),
          ]
    ...
    const renderSize = () => {
      ...
      return props.showSizer
        ? createVNode("div", { class: "k-page-sizer" }, [createVNode(Select, prop, null)])
        : null;
    };
    const renderElevator = () => {
      ...
      return props.showElevator
        ? createVNode("div", { class: "k-page-options" }, [
    ...
    return () => {
      const classes = [
        ...
        totalNode = props.showTotal
          ? createVNode("div", { class: "k-page-number" }, [
              createVNode("span", null, [
        ...
        childNodes.push(
          createVNode(
            ...
            { name: `k-${preCls}` },
            {
              default: () => [
                withDirectives(
                  createVNode("div", mergeProps({ class: cls }, _props), [
                    createVNode("div", { class: `k-${preCls}-content` }, [
            ...
            { name: `k-${preCls}` },
            {
              default: () => [
                withDirectives(
                  createVNode("div", mergeProps({ class: cls }, _props), [
                    createVNode("div", { class: `k-${preCls}-content` }, [
                      createVNode("div", { class: `k-${preCls}-body` }, [
                        createVNode(Icon, { type: Ol }, null),
                        createVNode("div", { class: `k-${preCls}-title` }, [title]),
                      ]),
                      createVNode("div", { class: `k-${preCls}-footer` }, [
                        createVNode(
                          Button,
                          {
                            size: "small",
                          ...
                          { default: () => [props.cancelText || locale.value?.k.common.cancel] }
                        ),
                        createVNode(
                          Button,
                          {
  ...
  setup(props, { slots }) {
    ...
    const renderTip = (status, type) => {
      ...
      if (props.format) text = props.format(currentPercent.value);
        ...
        if (currentPercent.value === 100) text = createVNode(Icon, { type: bc }, null);
        if (status === "exception") text = createVNode(Icon, { type: _c }, null);
      } else if (type === "circle" || type === "dashboard")
        if (slots.format) text = slots.format();
        else {
          if (currentPercent.value === 100) text = createVNode(Icon, { type: Bc }, null);
          if (status === "exception") text = createVNode(Icon, { type: cr }, null);
        }
    ...
    const renderCircle = (percent, strokeColor, dashboard) => {
      ...
      return createVNode("svg", { viewBox: `0 0 100 100` }, [
        createVNode("path", mergeProps({ "stroke-width": strokeWidth }, innerProps), null),
        createVNode("path", mergeProps({ "stroke-width": strokeWidth }, bgProps), null),
      ]);
    };
    const renderBar = () => {
      ...
      if (type === "line") {
        ...
        return createVNode("div", { class: "k-progress-inner" }, [
          createVNode(
            "div",
            {
              class: "k-progress-bg",
  ...
  setup(props, { slots, emit }) {
    ...
    return () => {
      ...
      return createVNode(
        ...
        [
          createVNode("span", { class: "k-radio-symbol" }, [
            createVNode(
              "input",
              {
                type: "radio",
          ...
          labelNode ? createVNode("span", { class: "k-radio-label" }, [labelNode]) : null,
        ]
      );
    };
  },
...
var star_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => {
      ...
      const node = createVNode("span", starClasses, [
        createVNode(
          "span",
          {
            class: ["k-star-front"],
        ...
        createVNode("span", { class: "k-star-back" }, [
          characterNode ||
            createVNode(
              Icon,
              {
      ...
      return tooltips
        ? createVNode(
            Tooltip,
            { title: tooltips },
            _isSlot$1(node) ? node : { default: () => [node] }
          )
        : node;
    };
  },
  ...
  setup(props, { emit }) {
    ...
    const update = (t, index, percent) => {
      if (t === "M") {
        ...
        if (props.allowHalf) tempValue.value = index - (percent < 0.5 ? 0.5 : 0);
    ...
    return () => {
      ...
      return createVNode(
        ...
        [
          stars,
          showScore ? createVNode("span", { class: "k-rate-score" }, [initValue.value]) : null,
        ]
      );
    };
  },
...
var Skeleton = /* @__PURE__ */ defineComponent({
  ...
  setup(ps, { slots }) {
    ...
    const renderAvatar = () => {
      ...
      return createVNode("div", { class: "k-skeleton-header" }, [
        createVNode(
          "span",
          {
            class: [
    ...
    const renderContent = () => {
      ...
      return createVNode("div", { class: "k-skeleton-content" }, [
        title > 0
          ? createVNode(
              "div",
              {
          ...
          : null,
        createVNode("ul", { class: "k-skeleton-paragraph" }, [
          lines.map(() => createVNode("li", null, null)),
        ]),
      ]);
    };
    return () => {
...
var SkeletonAvatar = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      return createVNode("div", _props, [
        child && !show.value ? child : createVNode("span", innerProps, null),
      ]);
    };
  },
});
...
var CountUp = class CountUp {
  ...
  constructor(target, endVal, options) {
    ...
    if (this.options.enableScrollSpy) this.options.autoAnimate = true;
    if (this.options.scrollSpyDelay !== void 0)
      this.options.autoAnimateDelay = this.options.scrollSpyDelay;
    if (this.options.scrollSpyOnce) this.options.autoAnimateOnce = true;
    ...
    if (typeof window !== "undefined" && this.options.autoAnimate)
      if (!this.error && typeof IntersectionObserver !== "undefined") this.setupObserver();
  ...
  determineDirectionAndSmartEasing() {
    ...
    if (
      ...
      this.endVal = end + (this.countDown ? 1 : -1) * (this.options.smartEasingAmount || 333);
  ...
  count = (timestamp) => {
    ...
    this.frameVal = (this.countDown ? this.frameVal < this.endVal : this.frameVal > this.endVal)
      ? this.endVal
      : this.frameVal;
    ...
    for (var i = 0; i < len; i++) {
      ...
      if (cell.current != ch) {
        ...
        cell.timerClean = setTimeout(
          ...
          ((options.duration || 0.8) + (options.duration || 0.25)) * 1e3 + 2500
        );
      }
    }
  }
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      return createVNode("div", { class: "k-stat-number" }, [
        prefixNode?.length > 0 &&
          createVNode("span", { class: "k-stat-number-prefix" }, [prefixNode]),
        createVNode(CountUpNumber, items, null),
        suffixNode?.length > 0 &&
          createVNode("span", { class: "k-stat-number-suffix" }, [suffixNode]),
      ]);
    };
  },
});
  ...
  setup(props, { slots }) {
    return () => {
      return createVNode(
        ...
        [
          props.title && createVNode("div", { class: "k-stat-card-title" }, [props.title]),
          createVNode("div", { class: "k-stat-card-items" }, [
            (props.items || []).map((item, index) => {
              return createVNode(
                ...
                [
                  createVNode("div", { class: "k-stat-card-item-value" }, [
                    createVNode(
                      StatNumber,
                      {
...
var Switch = /* @__PURE__ */ defineComponent({
  ...
  setup(ps, { slots, emit }) {
    ...
    return () => {
      ...
      const textNode =
        size != "small" && children
          ? createVNode("span", { class: "k-switch-inner" }, [
          ...
          createVNode("tr", { key: rowIndex }, [
            ...
            row.map((col, idx) =>
              createVNode(
                ...
                [
                  createVNode("div", { class: "k-table-header-col" }, [
                    ...
                    col.sorter &&
                      createVNode("span", { class: "k-table-sorter" }, [
                        createVNode(
                          Icon,
                          {
                            type: Lc,
          ...
          style: {
            width:
              props.scroll.x && typeof props.scroll.x === "number"
                ? `${props.scroll.x}px`
                : props.scroll.x || void 0,
            minWidth: !props.scroll.x ? "100%" : void 0,
            tableLayout: "fixed",
          },
        },
        [renderColGroup(isHeader), isHeader && renderThead(), isBody && renderTbody()]
      );
    };
    return () => {
      const tableCls = [
      ...
      const bodyContent = createVNode(
        ...
        [
          ...
          isEmpty && createVNode(Empty, { description: props.emptyText }, null),
        ]
      );
...
var TabPanel = /* @__PURE__ */ defineComponent({
  ...
  setup(_, { slots }) {
    ...
    return () => {
      return createVNode(
        "div",
        { class: ["k-tabs-tabpanel", { "k-tabs-tabpanel-active": activeKey.value == key }] },
        [slots.default?.()]
      );
    };
  },
...
var Tabs = /* @__PURE__ */ defineComponent({
  ...
  setup(ps, { slots, emit }) {
    ...
    const updateIndex = () => {
      nextTick(() => {
        currentIndex.value = getChildren(slots.default?.())
          ?.map((p) => p.key)
    ...
    return () => {
      ...
      return createVNode("div", { class: classes }, [
        createVNode("div", { class: "k-tabs-bar" }, [
          createVNode("div", { class: navCls }, [
            scrollable.value
              ? createVNode(
                  "span",
                  {
            ...
            scrollable.value
              ? createVNode(
                  ...
                  [createVNode(Icon, { type: Rc }, null)]
                )
              : null,
          ]),
          slots.extra ? createVNode("div", { class: "k-tabs-extra" }, [slots.extra()]) : null,
        ]),
        createVNode(
          "div",
          {
...
var TimeLine = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { slots }) {
    return () => {
      return createVNode("ul", { class: ["k-time-line", `k-time-line-${props.mode}`] }, [
        slots.default?.(),
      ]);
    };
  },
  ...
  setup(props, { slots }) {
    return () => {
      ...
      const iconNode =
        ...
        (icon
          ? createVNode(Icon, { type: icon }, null)
          : createVNode("span", { class: "k-time-line-head" }, null));
      const itemProps = {
        class: ["k-time-line-dot", { "k-time-line-dot-custom": !!slots.dot || !!icon }],
        style: styles,
      };
      const extraNode = props.extra || slots.extra?.();
      return createVNode("li", { class: "k-time-line-item" }, [
        createVNode("div", itemProps, [iconNode]),
        createVNode("div", { class: "k-time-line-item-content" }, [
          slots.default?.(),
...
var buildTree = ({
  ...
  if (checkable)
    if (!checkStrictly) calculateIndeterminateStates(result);
    else
      result.forEach((node) => {
        node.indeterminate = false;
      });
...
var Tree = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit, slots, attrs }) {
    ...
    const onLoadData = attrs.onLoadData;
    ...
    const handleExpand = (node) => {
      ...
      if (
        ...
        node.loading = true;
        const promise = onLoadData ? onLoadData(node) : void 0;
    ...
    const updateCheckState = {
      ...
      updateParents: (childKey) => {
        ...
        const updateParent = (nodeKey) => {
          ...
          if (!parent) return;
          const enabledChildren = defaultData.value
            .filter((item) => {
    ...
    const renderTreeNode = (item, i) => {
      ...
      if (!item.isLeaf) {
          ...
          [
            createVNode(
              Button,
              {
                ...
                icon: item.loading ? en : props.showLine ? (item.expanded ? Ha : c) : Rc,
              },
              null
            ),
          ]
        ...
        arrowCommentNode.push(createVNode("span", { class: "k-tree-arrow-placeholder" }, null));
      ...
      const titleNode = createVNode("span", titleProps, [
    ...
    return () => {
      ...
      return createVNode(
        ...
        [
          createVNode("div", { class: "k-tree-node-list" }, [
            createVNode(
              TransitionGroup,
              mergeProps(onProps, { tag: "div" }),
              _isSlot((_slot = visibleNodes.map((item, index) => renderTreeNode(item, index))))
                ? _slot
                : { default: () => [_slot] }
            ),
          ]),
...
var TreeSelect = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit, attrs }) {
    ...
    const onTreeLoadData = attrs.onTreeLoadData;
    ...
    const renderTree = () => {
      ...
      if (hasLoad) treePropsData.onLoadData = onTreeLoadData;
      return createVNode(Tree, treePropsData, null);
    };
    const queryKeydown = ({ key }) => {
      if (key === "Backspace") {
        if (queryKey.value === "" && props.multiple && currentValue.value.length > 0) {
    ...
    const renderOverlay = () => {
      ...
      const loadingNode = createVNode("div", { class: "k-tree-select-loading" }, [
        createVNode(
          Icon,
          {
            type: Ao,
    ...
    return () => {
      ...
      if (arrowIcon === void 0) arrowIcon = Nc;
      const childNode = [];
      const queryNode = withDirectives(
        createVNode(
          "div",
      ...
      const placeNode =
        placeholderText && isEmpty(labelText.value) && !queryKey.value
          ? createVNode("div", { class: "k-tree-select-placeholder" }, [placeholderText])
          : null;
      const renderTags = () => {
        let tags = labelText.value.map((label, i) => {
          return createVNode(
        ...
        if (props.maxTagCount && props.maxTagCount > 0 && tags.length > props.maxTagCount) {
          tags = tags.slice(0, props.maxTagCount);
          tags.push(
            createVNode("span", { class: "k-tree-select-tag" }, [
              createTextVNode("+"),
              labelText.value.length - props.maxTagCount,
              createTextVNode("..."),
            ])
      ...
      const labelsNode = props.multiple
        ? createVNode("div", { class: "k-tree-select-labels" }, [renderTags(), queryNode])
        : !isEmpty(labelText.value)
          ? withDirectives(
              createVNode("div", { class: "k-tree-select-label" }, [labelText.value[0]]),
              [[vShow, queryKey.value.length == 0]]
            )
          : null;
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    return () => {
      ...
      return createVNode(
        ...
        {
          default: () => [
            withDirectives(createVNode("div", tagProps, [content]), [[vShow, visible.value]]),
          ],
        }
      );
    };
  ...
  setup(props, { emit, slots }) {
    ...
    return () => {
      ...
      return (showUploadList && !isPicture) || isPicture
        ? createVNode("div", { class: `k-upload-${isPicture ? "picture" : "file"}-list` }, [
            fileList.map((item, i) => {
              const statusText =
                item.status === "success"
              ...
              return createVNode(
                ...
                [
                  createVNode(
                    ...
                    [getPreview(item) || createVNode(Icon, { type: Qr }, null)]
                  ),
                  createVNode("div", { class: "k-upload-file-item-info" }, [
                    !isPicture
                      ? createVNode("div", { class: "k-upload-file-main" }, [
                          createVNode("span", { class: "k-upload-file-name" }, [item.filename]),
                          createVNode("span", { class: "k-upload-file-size" }, [item.size]),
                        ])
                      : null,
                    item.status !== "waiting" &&
                      createVNode("div", { class: "k-upload-file-status" }, [
                        item.status === "uploading"
                          ...
                          : statusText && !isPicture
                            ? createVNode("div", { class: "k-upload-file-status-text" }, [
                                createVNode(Icon, { type: M }, null),
                                statusText,
                              ])
                            : null,
                        isPicture &&
                          ...
                          createVNode(
                            ...
                            { default: () => [createVNode(Icon, { type: M }, null)] }
                          ),
                      ]),
                  ]),
                  createVNode(
...
var selector_default = /* @__PURE__ */ defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    return () => {
      ...
      return showSelector
        ? createVNode("div", { class: "k-upload-select" }, [
            createVNode("div", addProps, [
              createVNode(
                "input",
                mergeProps(
                  {
              ...
              isPicture || draggable
                ? createVNode(Icon, { type: uploadIcon || l }, null)
                : slots.default?.(),
              (isPicture || (draggable && uploadText)) &&
                createVNode("span", { class: "k-upload-text" }, [uploadText]),
              draggable &&
                uploadSubText &&
                createVNode("span", { class: "k-upload-sub-text" }, [
  ...
  setup(props, { emit, slots, expose }) {
    ...
    const onSelectFiles = (files) => {
      ...
      Array.from(files)
        ...
        .forEach((file, index) => {
          ...
          if (
            (minSize !== void 0 && minSize >= 0 && fileSizeInKB < minSize) ||
            (maxSize !== void 0 && maxSize >= 0 && fileSizeInKB > maxSize)
          ) {
    ...
    const uploadFile = async (item, file) => {
      ...
      if (props.transformFile) {
        ...
        if (result instanceof Promise) result.then((f) => toUpload(item, f));
        else toUpload(item, result);
    ...
    return () => {
      ...
      const isPicture = type === "picture";
      const SelectorNode = createVNode(
        selector_default,
        mergeProps(
          { key: "selector" },
          {
      ...
      const FileListNode = createVNode(
        file_list_default,
        mergeProps(
          { key: "filelist" },
          {
...
var Theme = {
  ...
  setThemeMode(event, callback) {
    if (
      !(
        document.startViewTransition !== void 0 &&
...
var globalComponents = ["message", "modal", "notice", "loading", "theme"];
