...
| 属性 | 说明 | 类型 | 默认值 |
| --- | --- | --- | --- |
| align | 交叉轴对齐方式 | `"center" \| "start" \| "flex-start" \| "end" \| "flex-end" \| "baseline"` | 水平布局为 `center`，垂直布局为 `stretch` |
| justify | 主轴对齐方式 | `"center" \| "flex-start" \| "flex-end" \| "space-between" \| "space-around" \| "space-evenly"` | `flex-start` |
