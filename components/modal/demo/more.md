...
<template>
  <Space>
    ...
    <Modal title="Top 200px" v-model:show="show3" :top="200" @ok="show3=false">
      {{text}}
    </Modal>
    ...
    <Modal title="Click mask dont't be close" v-model:show="show5" :mask="false" :mask-closable="false" @ok="show5=false">
      {{text}}
    </Modal>

    <Modal title="No footer" v-model:show="show6" :footer="null" @ok="show6=false">
      {{text}}
    </Modal>
  </Space>
</template>
