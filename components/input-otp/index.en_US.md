...
| validator         | Custom validator for each character                        | (value: string) => boolean                     | -       |
| theme             | Visual theme                                               | 'fill' \| 'outline' \| 'underlined' \| 'plain' | fill    |
| shape             | Field shape                                                | ShapeType                                      | -       |
