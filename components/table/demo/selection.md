...
```tpl
<template>
  <Table :data="data" :columns="columns" @on-select="onSelect" @on-change="onChange">
  ...
  data(){
    return{
      data:[
        ...
        { key:'3', name:'Chuchur' ,gender: 1 , age:28 , address:'Wu Han Nanhu No. 188', tags:['Go','Python'] , _disabled:true},
      ],
      columns:[
        { type: 'selection'},
        { title:'Name', key:'name' },
