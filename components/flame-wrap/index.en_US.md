...
> Adapted from [Canvas UI FlameWrap](https://github.com/DavidHDev/canvas-ui/tree/main/src/lib/FlameWrap) by David Haz ([DavidHDev](https://github.com/DavidHDev)). The original project is licensed under MIT + Commons Clause.
