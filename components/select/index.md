...
| change      | 在选项状态发生改变时触发，返回当前value                         | Function(value)                                     | -           |
| select      | 选中或取消选中时触发,返回选中的value,label,是否选中(多选时区分) | Function(value, label, selected)                    | -           |
...
| placement   | 选择框弹出的位置                                                | `bottom-left` `bottom-right` `top-left` `top-right` | bottom-left |
| maxTagCount | 一次最多展示多少个tag                                           | Number                                              | -           |
