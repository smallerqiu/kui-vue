...
> Adapted from [Canvas UI Ripple](https://github.com/DavidHDev/canvas-ui/tree/main/src/lib/Ripple) by David Haz ([DavidHDev](https://github.com/DavidHDev)). The original project is licensed under MIT + Commons Clause.
