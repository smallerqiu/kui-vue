...
import { withInstall, cloneVNode, isVNode } from "../utils/vue";
          ...
          <div class="k-form-item-content">
            {children.map((child) => {
              if (isVNode(child)) {
                ...
                const disabled =
                  (child.componentOptions &&
                    child.componentOptions.propsData.disabled) ||
                  this.Form.disabled;
                const props = {
                ...
                if (
                  ["Input", "k-input", "TextArea", "k-textarea"].indexOf(tag) >
                  -1
                ) {
                  props.on.blur = () => {
            ...
            <transition name="k-form-item-fade">
              {!valid ? (
                <div class="k-form-item-error-tip">{this.message}</div>
              ) : null}
            </transition>
          </div>
        </Col>
