...
By setting the `multiple` attribute, you can support selecting and uploading multiple files simultaneously.
If not set, only one file can be uploaded by default.
</en>
