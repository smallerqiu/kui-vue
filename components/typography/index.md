...
| tag | 渲染的 HTML 标签 | `"span" \| "div" \| "h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6" \| "p"` | - |
...
| ellipsis | 文本省略、提示和展开配置 | `number \| boolean \| TypographyEllipsisOptions` | false |
| copy | 复制后触发 | `(value: string) => void` | - |
| change | 编辑完成后触发 | `(value: string) => void` | - |
