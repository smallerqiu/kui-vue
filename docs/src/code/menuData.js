...
code.nav = [
  {
    ...
    child: [
      ...
      { title: "SSR 支持", link: "/ssr", icon: 'ios-cloud' },
  ...
  },
  {
    ...
    child: [
      ...
      { title: "图片预览", sub: "imagePreview", link: "/image-preview", icon: 'ios-images' },
  ...
  },
  {
    ...
    child: [
      ...
      { title: "下拉菜单", sub: "Dropdown", link: "/dropdown", icon: 'ios-arrow-dropdown-circle' },
