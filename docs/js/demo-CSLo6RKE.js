...
*/
import{Bt as e,Q as t,c as n,nt as r,zt as i}from"./index-DH7LFVbd.js";var a=i({},function(){var e=this;return e._self._c,e._m(0)},[function(){var e=this,t=e._self._c;return t(`div`,{staticClass:`markdown-body`},[t(`h1`,[e._v(`Tabs 标签页`)]),t(`p`,[e._v(`选项卡切换组件。`)]),t(`h2`,{attrs:{id:`何时使用`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#何时使用`}},[e._v(`何时使用`)])]),t(`p`,[e._v(`提供平级的区域将大块内容进行收纳和展现，保持界面整洁。`)]),t(`ul`,[t(`li`,[e._v(`卡片式的页签，提供可关闭的样式，常用于容器顶部。`)]),t(`li`,[e._v(`标准线条式页签，用于容器内部的主功能切换，这是最常用的 Tabs。`)])]),t(`h2`,{attrs:{id:`代码演示`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#代码演示`}},[e._v(`代码演示`)])])])}],!1,null,null,null,null).exports,o=i({data(){return{current:`1`}},methods:{change(e){console.log(e)}}},function(){var e=this,t=e._self._c;return t(`Demo`,[t(`template`,{slot:`component`},[t(`Tabs`,{on:{change:e.change},model:{value:e.current,callback:function(t){e.current=t},expression:`current`}},[t(`TabPanel`,{key:`1`,attrs:{title:`Tab 1`}},[e._v(` Content of Tab Pane 1 `)]),t(`TabPanel`,{key:`2`,attrs:{title:`Tab 2`}},[e._v(` Content of Tab Pane 2 `)]),t(`TabPanel`,{key:`3`,attrs:{title:`Tab 3`}},[e._v(` Content of Tab Pane 3 `)])],1)],1),t(`template`,{slot:`description`},[t(`h4`,[e._v(`基本用法`)]),t(`p`,[e._v(`默认选中第一项。`)])]),t(`template`,{slot:`code`},[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Tabs`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`v-model`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"current"`)]),e._v(` @`),t(`span`,{staticClass:`hljs-attr`},[e._v(`change`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"change"`)]),e._v(`>`)]),e._v(`
...
`)])])])],2)},[],!1,null,null,null,null).exports,s=i({data(){return{current:`1`,disabled:!0}}},function(){var e=this,t=e._self._c;return t(`Demo`,[t(`template`,{slot:`component`},[t(`div`,[t(`Button`,{attrs:{size:`small`},on:{click:function(t){e.disabled=!e.disabled}}},[e._v(e._s(e.disabled?`Undisable`:`Disabled`))]),t(`br`),t(`br`),t(`Tabs`,{model:{value:e.current,callback:function(t){e.current=t},expression:`current`}},[t(`TabPanel`,{key:`1`,attrs:{title:`Tab 1`}},[e._v(` Content of Tab Pane 1 `)]),t(`TabPanel`,{key:`2`,attrs:{title:`Tab 2`,disabled:e.disabled}},[e._v(` Content of Tab Pane 2 `)]),t(`TabPanel`,{key:`3`,attrs:{title:`Tab 3`}},[e._v(` Content of Tab Pane 3 `)])],1)],1)]),t(`template`,{slot:`description`},[t(`h4`,[e._v(`禁用`)]),t(`p`,[e._v(`禁用某一项。`)])]),t(`template`,{slot:`code`},[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(` @`),t(`span`,{staticClass:`hljs-attr`},[e._v(`click`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"disabled=!disabled"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`size`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"small"`)]),e._v(`>`)]),e._v(e._s(e.disabled?`Undisable`:`Disabled`)),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(`>`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])])],2)},[],!1,null,null,null,null).exports,l=i({data(){return{LogoApple:t,LogoMicrosoft:r,current:`1`}}},function(){var e=this,t=e._self._c;return t(`Demo`,[t(`template`,{slot:`component`},[t(`Tabs`,{model:{value:e.current,callback:function(t){e.current=t},expression:`current`}},[t(`TabPanel`,{key:`1`,attrs:{title:`Tab 1`,icon:e.LogoApple}},[e._v(` Content of Tab Pane 1 `)]),t(`TabPanel`,{key:`2`,attrs:{title:`Tab 2`,icon:e.LogoMicrosoft}},[e._v(` Content of Tab Pane 2 `)])],1)],1),t(`template`,{slot:`description`},[t(`h4`,[e._v(`图标`)]),t(`p`,[e._v(`有图标的标签。`)])]),t(`template`,{slot:`code`},[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Tabs`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`v-model`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"current"`)]),e._v(`>`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])])],2)},[],!1,null,null,null,null).exports,u=i({data(){return{current:`1`}}},function(){var e=this,t=e._self._c;return t(`Demo`,[t(`template`,{slot:`component`},[t(`Tabs`,{model:{value:e.current,callback:function(t){e.current=t},expression:`current`}},[t(`TabPanel`,{key:`1`,attrs:{title:`Tab 1`}},[e._v(` Content of Tab Pane 1 `)]),t(`TabPanel`,{key:`2`,attrs:{title:`Tab 2`}},[e._v(` Content of Tab Pane 2 `)]),t(`TabPanel`,{key:`3`,attrs:{title:`Tab 3`}},[e._v(` Content of Tab Pane 3 `)]),t(`Button`,{attrs:{slot:`extra`,size:`small`},slot:`extra`},[e._v(`Extra Action`)])],1)],1),t(`template`,{slot:`description`},[t(`h4`,[e._v(`附加内容`)]),t(`p`,[e._v(`可以在页签右边添加附加操作。`)])]),t(`template`,{slot:`code`},[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Tabs`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`v-model`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"current"`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`TabPanel`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`key`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"1"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`title`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"Tab 1"`)]),e._v(`>`)]),e._v(`
      Content of Tab Pane 1
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`TabPanel`)]),e._v(`>`)]),e._v(`
    ...
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`TabPanel`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`key`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"3"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`title`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"Tab 3"`)]),e._v(`>`)]),e._v(`
      Content of Tab Pane 3
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`TabPanel`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`slot`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"extra"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`size`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"small"`)]),e._v(`>`)]),e._v(`Extra Action`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Tabs`)]),e._v(`>`)]),e._v(`
`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
`),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),t(`span`,{staticClass:`language-javascript`},[e._v(`
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`export`)]),e._v(` `),t(`span`,{staticClass:`hljs-keyword`},[e._v(`default`)]),e._v(`{
