import{Cn as e,H as t,Sn as n,U as r,en as i,pn as a,ut as o,w as s}from"./vue-B8LCe6Yo.js";import{m as c,o as l}from"./index-_kkE29nq.js";var u=c({},function(){var e=this;return e._self._c,e._m(0)},[function(){var e=this,t=e._self._c;return t(`div`,{staticClass:`markdown-body`},[t(`h1`,[e._v(`Upload 上传`)]),t(`p`,[e._v(`上传是将信息（网页、文字、图片、视频等）通过网页或者上传工具发布到远程服务器上的过程。`)]),t(`h2`,{attrs:{id:`何时使用`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#何时使用`}},[e._v(`何时使用`)])]),t(`ul`,[t(`li`,[e._v(`当需要上传一个或一些文件时。`)]),t(`li`,[e._v(`当需要展现上传的进度时。`)]),t(`li`,[e._v(`当需要使用拖拽交互时。`)])]),t(`h2`,{attrs:{id:`代码演示`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#代码演示`}},[e._v(`代码演示`)])])])}],!1,null,null,null,null).exports,d=c({__name:`basic`,setup(n){return{__sfc:!0,headers:e({authorization:`here is token`}),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList),e.file.status===`success`?l.success(`${e.file.filename} uploaded successfully`):e.file.status===`error`&&l.error(`${e.file.filename} upload failed.`)},CloudUpload:t}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-4511acf1`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,headers:n.headers},on:{change:n.handleChange}},[t(`Button`,{attrs:{icon:n.CloudUpload}},[e._v(`Click to upload`)])],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`点击上传`)]),t(`p`,[e._v(`经典款式，用户点击按钮弹出文件选择框。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,f=c({__name:`file-list`,setup(t){return{__sfc:!0,headers:e({authorization:`here is token`}),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList),e.file.status===`success`?l.success(`${e.file.filename} uploaded successfully`):e.file.status===`error`&&l.error(`${e.file.filename} upload failed.`)},CloudUploadOutline:r}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-fe1f0ba0`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,headers:n.headers,multiple:``},on:{change:n.handleChange}},[t(`Button`,{attrs:{icon:n.CloudUploadOutline}},[e._v(`Click to upload`)])],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`上传多个文件`)]),t(`p`,[e._v(`通过设置 multiple 属性可以支持同时选中多个文件上传。`),t(`br`),e._v(` 不设置为默认, 只能上传一个文件`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Upload`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`action`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"https://www.chuchur.com/api/upload/image"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`name`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"file"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:headers`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"headers"`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,m=c({__name:`transform`,setup(t){return{__sfc:!0,headers:e({authorization:`here is token`}),transformFile:e=>new Promise((t,n)=>{let r=document.createElement(`canvas`),i=r.getContext(`2d`,{willReadFrequently:!0}),a=new Image,o=e.name;a.onload=function(){r.width=200,r.height=300,i.drawImage(a,(a.width-r.width)/2,(a.height-r.height)/2,r.width,r.height);for(var e=r.toDataURL(`image/png`).split(`,`),n=e[0].match(/:(.*?);/)[1],s=atob(e[1]),c=s.length,l=new Uint8Array(c);c--;)l[c]=s.charCodeAt(c);t(new File([l],o,{type:n}))},a.src=URL.createObjectURL(e)}),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList)},CameraOutline:s}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-144a87f3`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,type:`picture`,headers:n.headers,transformFile:n.transformFile,limit:1,accept:`image/*`,uploadIcon:n.CameraOutline,uploadText:`上传头像`},on:{change:n.handleChange}})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`上传前处理图片`)]),t(`p`,[e._v(`利用 transformFile 可以在文件上传前处理文件, 上传之前压缩等`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Upload`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`action`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"https://www.chuchur.com/api/upload/image"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`name`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"file"`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,g=c({__name:`custom`,setup(t){let n=e(null),i=e(!0);return{__sfc:!0,uploadRef:n,disabled:i,prams:e({type:`image`,time:Date.now()}),headers:e({authorization:`here is token`}),beforeUpload:e=>{console.log(e.file,e.fileList),i.value=e.fileList.length==0},startUpload:()=>{console.log(`startUpload`,n),n.value.upload()},CloudUploadOutline:r}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-228a02da`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{ref:`uploadRef`,attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,headers:n.headers,data:n.prams,autoTrigger:!1,multiple:``},on:{"before-upload":n.beforeUpload,remove:n.beforeUpload}},[t(`Button`,{attrs:{icon:n.CloudUploadOutline}},[e._v(`点击选择上传文件`)])],1),t(`br`),t(`Button`,{attrs:{disabled:n.disabled},on:{click:n.startUpload}},[e._v(`开始上传`)])]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`手动上传/自定义属性`)]),t(`p`,[e._v(`通过设置 data、headers 可添加自定义上传属性`),t(`br`),e._v(` autoTrigger='false'，选中文件后将不会自动触发上传。需要手动调用 ref 上的 upload 方法触发`),t(`br`),e._v(` name 为上传文件名`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Upload`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`action`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"https://www.chuchur.com/api/upload/image"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`name`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"file"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:headers`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"headers"`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,_=c({__name:`directory`,setup(t){return{__sfc:!0,headers:e({authorization:`here is token`}),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList)},CloudUploadOutline:r}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-73af2d5c`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,directory:``,headers:n.headers},on:{change:n.handleChange}},[t(`Button`,{attrs:{icon:n.CloudUploadOutline}},[e._v(`Click to upload`)])],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`上传文件夹`)]),t(`p`,[e._v(`通过传入 directory 为 true，可以支持上传文件夹下的所有文件`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Upload`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`action`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"https://www.chuchur.com/api/upload/image"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`name`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"file"`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,v=c({__name:`pictures`,setup(t){return{__sfc:!0,headers:e({authorization:`here is token`}),fileList:e([{url:`https://cdn.chuchur.com/upload/demo/test_300.jpg`,status:`uploading`,filename:`test.jpg`,size:`222kb`,percent:50,status:`uploading`},{url:`https://cdn.chuchur.com/upload/demo/test_300.jpg`,status:`error`,filename:`test.jpg`,size:`222kb`}]),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList)}}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-6e1f99d4`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,type:`picture`,headers:n.headers,fileList:n.fileList,accept:`image/*`,uploadText:`上传图片`},on:{change:n.handleChange}})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`照片墙`)]),t(`p`,[e._v(`设置 type = 'picture'，用户可以上传图片并在列表中显示缩略图`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Upload`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`action`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"https://www.chuchur.com/api/upload/image"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`name`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"file"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`type`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"picture"`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,y=c({__name:`avatar`,setup(t){return{__sfc:!0,headers:e({authorization:`here is token`}),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList)},CameraOutline:s}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-ae21b81c`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,type:`picture`,headers:n.headers,limit:1,accept:`image/*`,uploadIcon:n.CameraOutline,uploadText:`上传头像`},on:{change:n.handleChange}})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`上传头像`)]),t(`p`,[e._v(`limit等于上传文件数量时, 则不显示选择文件组件,`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Upload`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`action`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"https://www.chuchur.com/api/upload/image"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`name`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"file"`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-attr`},[e._v(`type`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"picture"`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,b=c({__name:`draggable`,setup(t){return{__sfc:!0,headers:e({authorization:`here is token`}),handleChange:e=>{e.file.status!==`uploading`&&console.log(e.file,e.fileList),e.file.status===`success`?l.success(`${e.file.filename} uploaded successfully`):e.file.status===`error`&&l.error(`${e.file.filename} upload failed.`)},CloudUploadOutline:r}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-e486939c`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`div`,{staticStyle:{width:`100%`}},[t(`Upload`,{attrs:{action:`https://www.chuchur.com/api/upload/image`,name:`file`,headers:n.headers,draggable:``,uploadIcon:n.CloudUploadOutline,uploadText:`点击上传文件或拖拽文件到这里`,uploadSubText:`支持任意类型文件`},on:{change:n.handleChange}})],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`拖拽上传`)]),t(`p`,[e._v(`draggable='true'，可以使用拖拽功能`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
