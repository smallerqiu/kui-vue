...
`)])]),t(`h2`,{attrs:{id:`代码演示`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#代码演示`}},[e._v(`代码演示`)])])])}],!1,null,null,null,null).exports,r=t({methods:{upload(e){this.$Loading.upload(e)},start(){this.$Loading.start()},finish(){this.$Loading.finish()},error(){this.$Loading.error()},destroy(){this.$Loading.destroy()}}},function(){var e=this,t=e._self._c;return t(`Demo`,[t(`template`,{slot:`component`},[t(`Space`,{attrs:{wrap:``}},[t(`Button`,{on:{click:function(t){return e.start()}}},[e._v(`start`)]),t(`Button`,{on:{click:e.finish}},[e._v(`finish`)]),t(`Button`,{on:{click:e.error}},[e._v(`error`)]),t(`Button`,{on:{click:function(t){return e.upload(30)}}},[e._v(`upload 30%`)]),t(`Button`,{on:{click:function(t){return e.upload(80)}}},[e._v(`upload 80%`)]),t(`Button`,{on:{click:function(t){return e.destroy()}}},[e._v(`destroy`)])],1)],1),t(`template`,{slot:`description`},[t(`h4`,[e._v(`基本用法`)]),t(`p`,[e._v(`最简单的用法。`)])]),t(`template`,{slot:`code`},[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
