...
`)])])])}],!1,null,null,null,null).exports,m=d({__name:`mode`,setup(e){return{__sfc:!0,switchMode:e=>{f.info(`Current theme mode`),u.setThemeMode(e,e=>{f.info(`Current theme mode is ${e?`dark`:`light`}`)})}}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-70952b34`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Button`,{attrs:{theme:`light`},on:{click:n.switchMode}},[e._v(`切换主题`)])]},proxy:!0},{key:`description`,fn:function(){return[t(`h4`,[e._v(`切换主题`)]),t(`p`,[e._v(`简单的切换例子, 开箱即用`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`)])])]},proxy:!0}])})},[],!1,null,`3eb411d5`,null,null).exports,_={render(){return c(`div`,[c(p),c(m),c(h),c(g)])}};export{_ as default};