...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`style`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,`39113784`,null,null).exports,v={render(){return c(`div`,{class:`demo-layout`},[c(d),c(f),c(p),c(m),c(h),c(g),c(_)])}};export{v as default};