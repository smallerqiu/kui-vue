...
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,u=o({__name:`base-render`,setup(e){return{__sfc:!0,data:[{key:`0`,name:`Li Lei`,gender:0,age:32,address:`Wu Han Guanggu No. 328`,tags:[`Python`,`Java`]},{key:`1`,name:`Liu Hao`,gender:1,age:28,address:`Wu Han Hongshan No. 128`,tags:[`Python`,`Java`]},{key:`2`,name:`Hu Cong`,gender:0,age:28,address:`Wu Han Nanhu No. 198`,tags:[`JS`,`CSS`]},{key:`3`,name:`Qiu`,gender:1,age:28,address:`Wu Han Nanhu No. 188`,tags:[`Go`,`Python`]}],columns:[{title:`Name`,key:`name`},{title:`Age`,key:`age`},{title:`Gender`,key:`gender`,render:(e,{gender:r},i)=>e(`Icon`,{props:{type:r==1?n:t,color:r==1?`blue`:`#f50cff`,size:15}})},{title:`Address`,key:`address`},{title:`Tags`,key:`tags`,render:(e,{tags:t},n)=>e(`Space`,{},[t.map(function(t){return e(`Tag`,{props:{color:t==`Python`?`green`:`blue`}},t)})])},{title:`Operate`,key:`action`,render:(e,t,n)=>e(`Button`,{props:{size:`small`},on:{click:e=>{c.info({title:`More`,content:`My name is ${t.name}`})}}},`more`)}]}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-726245e2`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Table`,{attrs:{data:n.data,sticky:52,columns:n.columns}})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`基本用法(使用render)`)]),t(`p`,[e._v(`使用自定义`),t(`code`,[e._v(`render`)]),e._v(`来初始化表格`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`)])]),t(`h2`,{attrs:{id:`代码演示`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#代码演示`}},[e._v(`代码演示`)])])])}],!1,null,null,null,null).exports,p=o({__name:`table-sorter`,setup(t){let n=e([]),r=e(!1),i=[{title:`Name`,key:`name`,sorter:!0},{title:`Age`,key:`age`,sorter:!0},{title:`Email`,key:`mail`,sorter:e=>s(`mail`,e)}];a(()=>{s()});let o=({key:e,order:t})=>{console.log(e,t)},s=(e,t)=>{r.value=!0,setTimeout(()=>{r.value=!1,n.value=[{key:`0`,name:`Qiu`,age:32,mail:`chuchur@qq.com`},{key:`3`,name:`Wang Kang`,age:26,mail:`wangkang@gmail.com`},{key:`2`,name:`Liu Hao`,age:27,mail:`liuhao@162.com`},{key:`1`,name:`Li Lei`,age:33,mail:`hanlin@hotmail.com`},{key:`4`,name:`Hu Cong`,age:25,mail:`hucong@163.com`}]},2e3)};return{__sfc:!0,data:n,loading:r,columns:i,sort:o,fetch:s}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-7424c568`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Table`,{attrs:{data:n.data,columns:n.columns,loading:n.loading},on:{sort:n.sort}})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`排序`)]),t(`p`,[t(`code`,[e._v(`sorter=true`)]),e._v(` 现有的数据排序 , 为‘function’时,可自定义排序规则`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,h=o({__name:`col-row-span`,setup(e){return{__sfc:!0,data:[{key:`1`,name:`张三`,age:25,city:`北京`},{key:`2`,name:`李四`,age:30,city:`上海`},{key:`3`,name:`王五`,age:35,city:`广州`},{key:`4`,name:`赵六`,age:40,city:`深圳`},{key:`5`,name:`邱大`,age:38,city:`武汉`}],columns:[{title:`姓名`,key:`name`,width:100,rowSpan:(e,t)=>t==2?2:1},{title:`年龄`,key:`age`,width:100,colSpan:(e,t)=>t==1?2:1},{title:`城市`,key:`city`,width:100}]}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-53679428`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Table`,{attrs:{data:n.data,columns:n.columns,bordered:``}})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`表格行/列合并`)]),t(`p`,[e._v(`表头只支持列合并，使用 column 里的 colSpan 进行设置。`),t(`br`),e._v(` 表格支持行/列合并，使用 render 里的单元格属性 colSpan 或者 rowSpan 设值为 0 时，设置的表格不会渲染。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,_=o({__name:`fixed-col-head`,setup(e){let t=[],n={};for(let e=0;e<20;e++)t.push({title:`Col`+e,key:`address`+e,width:150}),n[`address`+e]=`Hubei Wuhan SoftBase No.128`;return{__sfc:!0,_columns:t,dataItem:n,data:Array(10).fill(``).map((e,t)=>({key:t,name:`Han Mei`,age:28,address:`Hubei Wuhan SoftBase No.128`,...n})),columns:[{title:`Name`,key:`name`,fixed:`left`},{title:`Age`,key:`age`,fixed:`left`},...t,{title:`Operate`,key:`action`,fixed:`right`},{title:`Operate`,key:`action1`,fixed:`right`}]}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-357c30f0`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Table`,{attrs:{data:n.data,columns:n.columns,scroll:{x:!0,y:300}},scopedSlots:e._u([{key:`action`,fn:function(){return[t(`Button`,{attrs:{size:`small`}},[e._v(`test`)])]},proxy:!0}])})]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`固定头/列`)]),t(`p`,[e._v(`对于列数很多的数据，可以固定前后的列，横向滚动查看其它数据，需要设置表格的宽度 `),t(`code`,[e._v(`scroll.x`)]),e._v(` 和 `),t(`code`,[e._v(`scroll.y `)]),t(`br`),e._v(` 如果布局被破坏，请把宽度 `),t(`code`,[e._v(`x`)]),e._v(` 值改大。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
