...
`)])])]},proxy:!0}])})},[],!1,null,`24be322c`,null,null).exports,p=u({__name:`layout1`,setup(e){return{__sfc:!0,top:o([`t1`]),LogoKui:a}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-7c43d89e`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`div`,{staticClass:`k-demo-layout`},[t(`Layout`,{staticClass:`layout-back`},[t(`Header`,{staticClass:`demo-header`},[t(`Row`,{staticClass:`demo-top-nav`,attrs:{type:`flex`,align:`middle`}},[t(`Col`,{staticStyle:{width:`194px`}},[t(`a`,{staticClass:`logo-box`,attrs:{href:``}},[t(`Icon`,{staticClass:`logo`,attrs:{type:n.LogoKui,size:`30`}}),e._v(` K UIKIT `)],1)]),t(`Col`,{attrs:{flex:`1`}},[t(`Menu`,{staticClass:`demo-top-menu`,attrs:{mode:`horizontal`,selectedKeys:[`t1`]}},[t(`MenuItem`,{key:`t1`},[e._v(`首页`)]),t(`MenuItem`,{key:`t2`},[e._v(`新闻`)]),t(`MenuItem`,{key:`t3`},[e._v(`知识库`)])],1)],1),t(`Col`,[t(`Space`,[t(`Avatar`,{staticStyle:{background:`#3a95ff`},attrs:{size:20}},[e._v(`Q`)])],1)],1)],1)],1),t(`Content`,{staticClass:`k-demo-main`},[t(`Breadcrumb`,{staticClass:`nav`},[t(`BreadcrumbItem`,[e._v(`Home`)]),t(`BreadcrumbItem`,[e._v(`List`)]),t(`BreadcrumbItem`,[e._v(`App`)])],1),t(`Content`,{staticClass:`demo-back`},[e._v(`Conent`)])],1),t(`Footer`,{staticStyle:{background:`transparent`}},[e._v(`KUI ©2025 Created by chuchur`)])],1)],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`上中下布局`)]),t(`p`,[e._v(`最基本的『上-中-下』布局。`),t(`br`),e._v(` 一般主导航放置于页面的顶端，从左自右依次为：logo、一级导航项、辅助菜单（用户、设置、通知等）。通常将内容放在固定尺寸（例如：1200px）内，整个页面排版稳定，不受用户终端显示器影响；上下级的结构符合用户上下浏览的习惯，也是较为经典的网站导航模式。页面上下切分的方式提高了主工作区域的信息展示效率，但在纵向空间上会有一些牺牲。此外，由于导航栏水平空间的限制，不适合那些一级导航项很多的信息结构。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-layout"`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"layout-back"`)]),e._v(`>`)]),e._v(`
        ...
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Row`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`type`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"flex"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`align`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"middle"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-top-nav"`)]),e._v(`>`)]),e._v(`
          ...
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Col`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`flex`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"1"`)]),e._v(`>`)]),e._v(`
            `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Menu`)]),e._v(`
              `),t(`span`,{staticClass:`hljs-attr`},[e._v(`mode`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"horizontal"`)]),e._v(`
              `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:selectedKeys`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"['t1']"`)]),e._v(`
              `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-top-menu"`)]),e._v(`
            >`)]),e._v(`
      ...
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Footer`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`style`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"background:transparent;"`)]),e._v(`
        >`)]),e._v(`KUI ©2025 Created by chuchur</Footer
      >
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(`>`)]),e._v(`
...
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`import`)]),e._v(` { `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`LogoKui`)]),e._v(`, `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`Search`)]),e._v(`, `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`NotificationsOutline`)]),e._v(` } `),t(`span`,{staticClass:`hljs-keyword`},[e._v(`from`)]),e._v(` `),t(`span`,{staticClass:`hljs-string`},[e._v(`"kui-icons"`)]),e._v(`;
...
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` top = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`([`),t(`span`,{staticClass:`hljs-string`},[e._v(`"t1"`)]),e._v(`]);
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`style`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,`7dab9aff`,null,null).exports,m=u({},function(){var e=this,t=e._self._c;return t(`Demo`,{attrs:{id:`k-7c42efe0`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`顶部-侧边布局`)]),t(`p`,[e._v(`拥有顶部导航及侧边栏的页面，多用于展示类网站。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`cn`)]),e._v(`>`)]),e._v(`
### 顶部-侧边布局
拥有顶部导航及侧边栏的页面，多用于展示类网站。
`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`cn`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,null,null,null).exports,h=u({__name:`layout3`,setup(e){return{__sfc:!0,LogoKui:a,Home:c,StatsChart:s,Settings:t}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-7c420722`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`div`,{staticClass:`k-demo-layout`},[t(`Layout`,{staticClass:`layout-back`},[t(`Header`,{staticClass:`demo-header`},[t(`Row`,{staticClass:`demo-top-nav`,attrs:{type:`flex`,align:`middle`}},[t(`Col`,{staticStyle:{width:`194px`}},[t(`a`,{staticClass:`logo-box`,attrs:{href:``}},[t(`Icon`,{staticClass:`logo`,attrs:{type:n.LogoKui,size:`30`}}),e._v(` K UIKIT `)],1)]),t(`Col`,{attrs:{flex:`1`}},[t(`Menu`,{staticClass:`demo-top-menu`,attrs:{mode:`horizontal`,selectedKeys:[`t1`]}},[t(`MenuItem`,{key:`t1`},[e._v(`首页`)]),t(`MenuItem`,{key:`t2`},[e._v(`新闻`)]),t(`MenuItem`,{key:`t3`},[e._v(`知识库`)])],1)],1),t(`Col`,[t(`Space`,[t(`Avatar`,{staticStyle:{background:`#3a95ff`},attrs:{size:20}},[e._v(`Q`)])],1)],1)],1)],1),t(`Layout`,[t(`Sider`,{staticClass:`demo-back`},[t(`Menu`,{staticClass:`demo-left-menu`,staticStyle:{"padding-top":`20px`},attrs:{selectedKeys:[`t1`],openKeys:[`t2`],mode:`inline`}},[t(`MenuItem`,{key:`t1`,attrs:{icon:n.Home}},[e._v(`首页`)]),t(`SubMenu`,{key:`t2`,attrs:{icon:n.StatsChart,title:`数据统计`}},[t(`MenuItem`,{key:`t2-1`},[e._v(`今日订单`)]),t(`MenuItem`,{key:`t2-2`},[e._v(`今日销售额`)])],1),t(`MenuItem`,{key:`t3`,attrs:{icon:n.Settings}},[e._v(`能源管理`)])],1)],1),t(`Layout`,{staticClass:`k-demo-main`},[t(`Breadcrumb`,{staticClass:`nav`},[t(`BreadcrumbItem`,[e._v(`Home`)]),t(`BreadcrumbItem`,[e._v(`List`)]),t(`BreadcrumbItem`,[e._v(`App`)])],1),t(`Content`,{staticClass:`demo-content`},[e._v(` Content `)])],1)],1)],1)],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`顶部-侧边布局-通栏`)]),t(`p`,[e._v(`同样拥有顶部导航及侧边栏，区别是两边未留边距，多用于应用型的网站。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-layout"`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"layout-back"`)]),e._v(`>`)]),e._v(`
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Header`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-header"`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Row`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`type`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"flex"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`align`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"middle"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-top-nav"`)]),e._v(`>`)]),e._v(`
      ...
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Sider`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-back"`)]),e._v(`>`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Menu`)]),e._v(`
            ...
            `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-left-menu"`)]),e._v(`
            `),t(`span`,{staticClass:`hljs-attr`},[e._v(`mode`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"inline"`)]),e._v(`
            `),t(`span`,{staticClass:`hljs-attr`},[e._v(`style`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"padding-top:20px;"`)]),e._v(`
          >`)]),e._v(`
        ...
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-main"`)]),e._v(`>`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Breadcrumb`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"nav"`)]),e._v(`>`)]),e._v(`
            ...
            `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`BreadcrumbItem`)]),e._v(`>`)]),e._v(`App`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`BreadcrumbItem`)]),e._v(`>`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Breadcrumb`)]),e._v(`>`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Content`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-content"`)]),e._v(`>`)]),e._v(` Content `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Content`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(`>`)]),e._v(`
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(`>`)]),e._v(`
...
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`import`)]),e._v(` {
  ...
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`StatsChart`)]),e._v(`,
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`Settings`)]),e._v(`,
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`Scan`)]),e._v(`,
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`style`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,`dcbd7756`,null,null).exports,g=u({__name:`layout4`,setup(r){return{__sfc:!0,top:o([`t1`]),collapsed:o(!1),selectedKeys:o([`t1`]),openKeys:o([`t2`]),LogoKui:a,Home:c,StatsChart:s,Settings:t,ChevronBack:n,ChevronForward:e}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-7c411e64`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`div`,{staticClass:`k-demo-layout`},[t(`Layout`,{staticClass:`layout-back`},[t(`Sider`,{class:[`demo-sider`,{"demo-sider-collapsed":n.collapsed}]},[t(`a`,{staticClass:`logo-box`,attrs:{href:``}},[t(`Icon`,{staticClass:`logo`,attrs:{type:n.LogoKui,size:`30`}}),t(`span`,{staticClass:`logo-title`},[e._v(`KUI运营后台`)])],1),t(`Menu`,{staticClass:`demo-left-menu`,attrs:{openKeys:n.openKeys,mode:`inline`,"inline-collapsed":n.collapsed},model:{value:n.selectedKeys,callback:function(e){n.selectedKeys=e},expression:`selectedKeys`}},[t(`MenuItem`,{key:`t1`,attrs:{icon:n.Home}},[e._v(`首页`)]),t(`SubMenu`,{key:`t2`,attrs:{icon:n.StatsChart,title:`数据统计`}},[t(`MenuItem`,{key:`t2-1`},[e._v(`今日订单`)]),t(`MenuItem`,{key:`t2-2`},[e._v(`今日销售额`)])],1),t(`SubMenu`,{key:`t3`,attrs:{icon:n.StatsChart,title:`数据统计`}},[t(`MenuItem`,{key:`t3-1`},[e._v(`今日订单`)]),t(`MenuItem`,{key:`t3-2`},[e._v(`今日销售额`)])],1),t(`MenuItem`,{key:`t4`,attrs:{icon:n.Settings}},[e._v(`能源管理`)])],1),t(`Button`,{staticClass:`btn-collapsed`,attrs:{type:`text`,block:``,size:`large`,icon:n.collapsed?n.ChevronForward:n.ChevronBack},on:{click:function(e){n.collapsed=!n.collapsed}}},[t(`i`)])],1),t(`Content`,{staticClass:`k-demo-main`},[t(`Breadcrumb`,{staticClass:`nav`},[t(`BreadcrumbItem`,[e._v(`Home`)]),t(`BreadcrumbItem`,[e._v(`List`)]),t(`BreadcrumbItem`,[e._v(`App`)])],1),t(`div`,{staticClass:`demo-back`,staticStyle:{padding:`200px 0`,"text-align":`center`,color:`#ddd`,margin:`20px`}},[e._v(` Content `)]),t(`Footer`,[e._v(`KUI ©2025 Created by chuchur`)])],1)],1)],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`固定侧边栏`)]),t(`p`,[e._v(`当内容较长时，使用固定侧边栏可以提供更好的体验。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-layout"`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"layout-back"`)]),e._v(`>`)]),e._v(`
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Sider`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"['demo-sider', { 'demo-sider-collapsed': collapsed }]"`)]),e._v(`>`)]),e._v(`
        ...
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`a`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Menu`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`v-model:selectedKeys`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"selectedKeys"`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:openKeys`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"openKeys"`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-left-menu"`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`mode`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"inline"`)]),e._v(`
        ...
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(`
          ...
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`size`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"large"`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:icon`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"collapsed ? ChevronForward : ChevronBack"`)]),e._v(`
          @`),t(`span`,{staticClass:`hljs-attr`},[e._v(`click`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"collapsed = !collapsed"`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"btn-collapsed"`)]),e._v(`
          >`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`i`)]),e._v(`>`)]),e._v(`</i
      ...
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Content`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-main"`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Breadcrumb`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"nav"`)]),e._v(`>`)]),e._v(`
          ...
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`BreadcrumbItem`)]),e._v(`>`)]),e._v(`App`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`BreadcrumbItem`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Breadcrumb`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`style`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"padding:200px 0;text-align:center;color:#ddd;margin:20px;"`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"demo-back"`)]),e._v(`
        >`)]),e._v(`
          Content
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Footer`)]),e._v(`>`)]),e._v(`KUI ©2025 Created by chuchur`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Footer`)]),e._v(`>`)]),e._v(`
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Content`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(`>`)]),e._v(`
`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`import`)]),e._v(` { ref } `),t(`span`,{staticClass:`hljs-keyword`},[e._v(`from`)]),e._v(` `),t(`span`,{staticClass:`hljs-string`},[e._v(`"vue"`)]),e._v(`;
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` top = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`([`),t(`span`,{staticClass:`hljs-string`},[e._v(`"t1"`)]),e._v(`]);
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` collapsed = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`(`),t(`span`,{staticClass:`hljs-literal`},[e._v(`false`)]),e._v(`);
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` selectedKeys = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`([`),t(`span`,{staticClass:`hljs-string`},[e._v(`"t1"`)]),e._v(`]);
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` openKeys = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`([`),t(`span`,{staticClass:`hljs-string`},[e._v(`"t2"`)]),e._v(`]);
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`script`)]),e._v(`>`)]),e._v(`
`),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`style`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`scoped`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`lang`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"less"`)]),e._v(`>`)]),t(`span`,{staticClass:`language-css`},[e._v(`
`),t(`span`,{staticClass:`hljs-selector-class`},[e._v(`.k-demo-layout`)]),e._v(` {
  `),t(`span`,{staticClass:`hljs-attribute`},[e._v(`overflow`)]),e._v(`: hidden;
  ...
  `),t(`span`,{staticClass:`hljs-selector-class`},[e._v(`.demo-sider-collapsed`)]),e._v(` {
    `),t(`span`,{staticClass:`hljs-attribute`},[e._v(`width`)]),e._v(`: `),t(`span`,{staticClass:`hljs-number`},[e._v(`60px`)]),e._v(`;
    `),t(`span`,{staticClass:`hljs-attribute`},[e._v(`overflow`)]),e._v(`: hidden;
    ...
    `),t(`span`,{staticClass:`hljs-selector-class`},[e._v(`.logo-box`)]),e._v(` {
      `),t(`span`,{staticClass:`hljs-attribute`},[e._v(`padding-left`)]),e._v(`: `),t(`span`,{staticClass:`hljs-number`},[e._v(`16px`)]),e._v(`;
    }
  }
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`style`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,`90af1cbf`,null,null).exports,_=u({__name:`layout5`,setup(e){return{__sfc:!0,top:o([`t1`]),collapsed:o(!1),selectedKeys:o([`t1`]),openKeys:o([`t2`]),LogoKui:a,Home:c,StatsChart:s,Settings:t,MenuFold:r,MenuUnfold:i}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-7c4035a6`,direction:`vertical`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`div`,{staticClass:`k-demo-layout`},[t(`Layout`,{staticClass:`layout-back`},[t(`Sider`,{class:[`demo-sider`,{"demo-sider-collapsed":n.collapsed}]},[t(`a`,{staticClass:`logo-box`,attrs:{href:``}},[t(`Icon`,{staticClass:`logo`,attrs:{type:n.LogoKui,size:`30`}}),t(`span`,{staticClass:`logo-title`},[e._v(`KUI运营后台`)])],1),t(`Menu`,{staticClass:`demo-left-menu`,attrs:{openKeys:n.openKeys,mode:`inline`,"inline-collapsed":n.collapsed},model:{value:n.selectedKeys,callback:function(e){n.selectedKeys=e},expression:`selectedKeys`}},[t(`MenuItem`,{key:`t1`,attrs:{icon:n.Home}},[e._v(`首页`)]),t(`SubMenu`,{key:`t2`,attrs:{icon:n.StatsChart,title:`数据统计`}},[t(`MenuItem`,{key:`t2-1`},[e._v(`今日订单`)]),t(`MenuItem`,{key:`t2-2`},[e._v(`今日销售额`)])],1),t(`SubMenu`,{key:`t3`,attrs:{icon:n.StatsChart,title:`数据统计`}},[t(`MenuItem`,{key:`t3-1`},[e._v(`今日订单`)]),t(`MenuItem`,{key:`t3-2`},[e._v(`今日销售额`)])],1),t(`MenuItem`,{key:`t4`,attrs:{icon:n.Settings}},[e._v(`能源管理`)])],1)],1),t(`Content`,{staticClass:`k-demo-main`},[t(`div`,{staticStyle:{padding:`10px`}},[t(`Button`,{staticClass:`btn-collapsed`,attrs:{type:`text`,icon:n.collapsed?n.MenuUnfold:n.MenuFold},on:{click:function(e){n.collapsed=!n.collapsed}}},[t(`i`)])],1),t(`Breadcrumb`,{staticClass:`nav`},[t(`BreadcrumbItem`,[e._v(`Home`)]),t(`BreadcrumbItem`,[e._v(`List`)]),t(`BreadcrumbItem`,[e._v(`App`)])],1),t(`div`,{staticClass:`demo-back`,staticStyle:{padding:`200px 0`,"text-align":`center`,color:`#ddd`,margin:`20px`}},[e._v(` Content `)]),t(`Footer`,[e._v(`KUI ©2025 Created by chuchur`)])],1)],1)],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`侧边布局/折叠模式`)]),t(`p`,[e._v(`侧边两列式布局。页面横向空间有限时，侧边导航可收起。`),t(`br`),e._v(` 侧边导航在页面布局上采用的是左右的结构，一般主导航放置于页面的左侧固定位置，辅助菜单放置于工作区顶部。内容根据浏览器终端进行自适应，能提高横向空间的使用率，但是整个页面排版不稳定。侧边导航的模式层级扩展性强，一、二、三级导航项目可以更为顺畅且具关联性的被展示，同时侧边导航可以固定，使得用户在操作和浏览中可以快速的定位和切换当前位置，有很高的操作效率。但这类导航横向页面内容的空间会被牺牲一部份。`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-layout"`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Layout`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"layout-back"`)]),e._v(`>`)]),e._v(`
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Sider`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"['demo-sider', { 'demo-sider-collapsed': collapsed }]"`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`a`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"logo-box"`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`href`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`""`)]),e._v(`>`)]),e._v(`
      ...
      `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Content`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"k-demo-main"`)]),e._v(`>`)]),e._v(`
        `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`style`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"padding: 10px;"`)]),e._v(`>`)]),e._v(`
          `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(`
            `),t(`span`,{staticClass:`hljs-attr`},[e._v(`type`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"text"`)]),e._v(`
            `),t(`span`,{staticClass:`hljs-attr`},[e._v(`:icon`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"collapsed ? MenuUnfold : MenuFold"`)]),e._v(`
            @`),t(`span`,{staticClass:`hljs-attr`},[e._v(`click`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"collapsed = !collapsed"`)]),e._v(`
            `),t(`span`,{staticClass:`hljs-attr`},[e._v(`class`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"btn-collapsed"`)]),e._v(`
            >`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`i`)]),e._v(`>`)]),e._v(`</i
          >`),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`Button`)]),e._v(`>`)]),e._v(`
...
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`import`)]),e._v(` {
  ...
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`StatsChart`)]),e._v(`,
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`Settings`)]),e._v(`,
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`MenuFold`)]),e._v(`,
  `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`MenuUnfold`)]),e._v(`,
} `),t(`span`,{staticClass:`hljs-keyword`},[e._v(`from`)]),e._v(` `),t(`span`,{staticClass:`hljs-string`},[e._v(`"kui-icons"`)]),e._v(`;
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`import`)]),e._v(` { ref } `),t(`span`,{staticClass:`hljs-keyword`},[e._v(`from`)]),e._v(` `),t(`span`,{staticClass:`hljs-string`},[e._v(`"vue"`)]),e._v(`;
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` top = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`([`),t(`span`,{staticClass:`hljs-string`},[e._v(`"t1"`)]),e._v(`]);
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` collapsed = `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`ref`)]),e._v(`(`),t(`span`,{staticClass:`hljs-literal`},[e._v(`false`)]),e._v(`);
...
`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`style`)]),e._v(`>`)]),e._v(`
`)])])]},proxy:!0}])})},[],!1,null,`e5b696f8`,null,null).exports,v={render(){return l(`div`,{class:`demo-layout`},[l(d),l(f),l(p),l(m),l(h),l(g),l(_)])}};export{v as default};