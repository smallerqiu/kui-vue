import{Cn as e,T as t,Wt as n,pn as r}from"./vue-B8LCe6Yo.js";import{m as i}from"./index-_kkE29nq.js";var a=i({},function(){var e=this;return e._self._c,e._m(0)},[function(){var e=this,t=e._self._c;return t(`div`,{staticClass:`markdown-body`},[t(`h1`,[e._v(`Select 选择器`)]),t(`p`,[e._v(`下拉选择器。`)]),t(`h2`,{attrs:{id:`何时使用`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#何时使用`}},[e._v(`何时使用`)])]),t(`ul`,[t(`li`,[e._v(`弹出一个下拉菜单给用户选择操作，用于代替原生的选择器，或者需要一个更优雅的多选器时。`)]),t(`li`,[e._v(`当选项少时（少于 5 项），建议直接将选项平铺，使用 Radio 是更好的选择。`)])]),t(`h2`,{attrs:{id:`代码演示`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#代码演示`}},[e._v(`代码演示`)])])])}],!1,null,null,null,null).exports,o=i({__name:`basic`,setup(t){return{__sfc:!0,value1:e(2),value2:e(2),data:[{label:`Apple`,value:0},{label:`Orange`,value:1},{label:`Banana`,value:2},{label:`Pear`,value:3},{label:`Grape`,value:4}]}}},function(){var e=this,t=e._self._c,n=e._self._setupProxy;return t(`Demo`,{attrs:{id:`k-4c98fea8`,direction:`horizontal`},scopedSlots:e._u([{key:`component`,fn:function(){return[t(`Space`,{attrs:{vertical:``}},[e._v(` use options to set options `),t(`Select`,{attrs:{options:n.data},model:{value:n.value1,callback:function(e){n.value1=e},expression:`value1`}}),t(`br`),e._v(` use children to set options `),t(`Select`,{model:{value:n.value2,callback:function(e){n.value2=e},expression:`value2`}},[t(`Option`,{attrs:{value:0}},[e._v(`Grape`)]),t(`Option`,{attrs:{value:1,label:`Apple`}}),t(`Option`,{attrs:{value:2,label:`Orange`}}),t(`Option`,{attrs:{value:3,label:`Banana`}}),t(`Option`,{attrs:{value:4,label:`Pear`}})],1)],1)]},proxy:!0},{key:`description`,fn:function(){return[t(`h3`,[e._v(`单选`)]),t(`p`,[e._v(`通过 `),t(`code`,[e._v(`v-model`)]),e._v(` 进行数据双向绑定`)])]},proxy:!0},{key:`code`,fn:function(){return[t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
...
`),t(`span`,{staticClass:`hljs-keyword`},[e._v(`const`)]),e._v(` `),t(`span`,{staticClass:`hljs-title function_`},[e._v(`fetchData`)]),e._v(` = (`),t(`span`,{staticClass:`hljs-params`}),e._v(`) => {
  ...
  `),t(`span`,{staticClass:`hljs-built_in`},[e._v(`setTimeout`)]),e._v(`(`),t(`span`,{staticClass:`hljs-function`},[e._v(`() =>`)]),e._v(` {
    optionsData.`),t(`span`,{staticClass:`hljs-property`},[e._v(`value`)]),e._v(` = options;
