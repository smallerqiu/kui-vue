import{m as e}from"./index-_kkE29nq.js";var t=e({},function(){var e=this;return e._self._c,e._m(0)},[function(){var e=this,t=e._self._c;return t(`div`,{staticClass:`markdown-body`},[t(`h1`,[e._v(`快速上手`)]),t(`p`,[e._v(`在开始之前，如果您刚开始接触Vue，建议您先细看 Vue及其相关文档： `),t(`a`,{attrs:{href:`https://vuejs.org`}},[e._v(`vue`)]),e._v(`，`),t(`a`,{attrs:{href:`https://vuex.vuejs.org`}},[e._v(`vuex`)]),e._v(`，`),t(`a`,{attrs:{href:`http://router.vuejs.org/`}},[e._v(`vue-router`)]),e._v(`，`),t(`a`,{attrs:{href:`https://vite.dev/`}},[e._v(`vite`)]),e._v(`，`),t(`a`,{attrs:{href:`https://github.com/vuejs/vue-devtools`}},[e._v(`vue-devtools`)])]),t(`h2`,{attrs:{id:`1.-初始化一个项目`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#1.-初始化一个项目`}},[e._v(`1. 初始化一个项目`)])]),t(`pre`,[t(`code`,{staticClass:`hljs language-bash`},[t(`span`,{staticClass:`hljs-comment`},[e._v(`# npm 7+，需要添加额外的 --：`)]),e._v(`
$ npm create vite@latest my-app -- --template vue
`),t(`span`,{staticClass:`hljs-comment`},[e._v(`#or`)]),e._v(`
$ yarn create vite my-app --template vue
`)])]),t(`p`,[e._v(`然后按照提示操作即可！`)]),t(`p`,[e._v(`当前文档是vue2 , vite 默认用的vue3, 所以需要降级`)]),t(`pre`,[t(`code`,{staticClass:`hljs language-sh`},[e._v(`npm install vue@2.x

`),t(`span`,{staticClass:`hljs-comment`},[e._v(`# 对应的vue-router 也要降级`)]),e._v(`
npm install vue-router@3.x

`),t(`span`,{staticClass:`hljs-comment`},[e._v(`# 对应的vuex 也要降级`)]),e._v(`
npm install vuex@3.x

`),t(`span`,{staticClass:`hljs-comment`},[e._v(`# vite 插件降级`)]),e._v(`
npm install @vitejs/plugin-vue2

`),t(`span`,{staticClass:`hljs-comment`},[e._v(`# 如果你使用了jsx`)]),e._v(`
npm install @vitejs/plugin-vue2-jsx
`)])]),t(`h2`,{attrs:{id:`2.-使用组件`,tabindex:`-1`}},[t(`a`,{staticClass:`header-anchor`,attrs:{href:`#2.-使用组件`}},[e._v(`2. 使用组件`)])]),t(`p`,[e._v(`从 yarn 或 npm 安装并引入 kui-vue。`)]),t(`pre`,[t(`code`,{staticClass:`hljs language-bash`},[e._v(`$ npm install kui-vue
`),t(`span`,{staticClass:`hljs-comment`},[e._v(`#or`)]),e._v(`
$ yarn add kui-vue
`)])]),t(`p`,[e._v(`一般在入口页面 `),t(`code`,[e._v(`main.js`)]),e._v(` 中如下配置：`)]),t(`pre`,[t(`code`,{staticClass:`hljs language-js`},[t(`span`,{staticClass:`hljs-keyword`},[e._v(`import`)]),e._v(` `),t(`span`,{staticClass:`hljs-title class_`},[e._v(`Vue`)]),e._v(` `),t(`span`,{staticClass:`hljs-keyword`},[e._v(`from`)]),e._v(` `),t(`span`,{staticClass:`hljs-string`},[e._v(`"vue"`)]),e._v(`;
...
`)])]),t(`p`,[e._v(`但是 `),t(`code`,[e._v(`Switch`)]),e._v(` 、 `),t(`code`,[e._v(`Image`)]),e._v(` 只支持 以k开头 :`)]),t(`pre`,[t(`code`,{staticClass:`hljs language-html`},[t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`template`)]),e._v(`>`)]),e._v(`
  `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`div`)]),e._v(`>`)]),e._v(`
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`KSwitch`)]),e._v(` `),t(`span`,{staticClass:`hljs-attr`},[e._v(`type`)]),e._v(`=`),t(`span`,{staticClass:`hljs-string`},[e._v(`"primary"`)]),e._v(`>`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`KSwitch`)]),e._v(`>`)]),e._v(` ✅ 推荐
    `),t(`span`,{staticClass:`hljs-tag`},[e._v(`<`),t(`span`,{staticClass:`hljs-name`},[e._v(`KImage`)]),e._v(`>`)]),t(`span`,{staticClass:`hljs-tag`},[e._v(`</`),t(`span`,{staticClass:`hljs-name`},[e._v(`KImage`)]),e._v(`>`)]),e._v(` ✅
    `),t(`span`,{staticClass:`hljs-comment`},[e._v(`<!-- ok -->`)]),e._v(`
